# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c" 2
# 52 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c"
void pmu_deinit(void)
{
...
# 70 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c"
void pmu_deepsleep_voltage_select(uint32_t dsv_n)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000000U)) &= ~((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(13))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000000U)) |= (dsv_n & ((uint32_t)0x3000U));
}
...
void pmu_low_power_ldo_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(18)));
}
...
# 107 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c"
void pmu_to_sleepmode(uint8_t sleepmodecmd)
{
...
# 135 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c"
void pmu_to_deepsleepmode(uint8_t deepsleepmodecmd, uint8_t deepsleepmode)
{

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000000U)) &= ~((uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1))))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000000U)) |= (deepsleepmode & ((uint32_t)0x3U));
...
void pmu_to_standbymode(void)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000000U)) |= (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1))))&((uint32_t)(3)<<0));


    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000000U)) |= (((uint32_t)((uint32_t)0x01U<<(2))) | ((uint32_t)((uint32_t)0x01U<<(3))));


    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (1UL << 2U);

    (*(volatile uint32_t *)(uint32_t)(0xE000E010U)) &= 0x00010004U;
    (*(volatile uint32_t *)(uint32_t)(0xE000E180U)) = 0xFFFFFFF3U;
...
# 196 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c"
void pmu_wakeup_pin_enable(uint32_t wakeup_pin)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000004U)) |= (wakeup_pin & ((uint32_t)0x2F00U));
}
# 213 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c"
void pmu_wakeup_pin_disable(uint32_t wakeup_pin)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000004U)) &= ~(wakeup_pin & ((uint32_t)0x2F00U));
}
...
# 249 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c"
void pmu_eflash_run_power_config(ControlStatus state)
{
    if(ENABLE == state) {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000008U)) &= ~((uint32_t)((uint32_t)0x01U<<(4)));
    } else {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000008U)) |= ((uint32_t)((uint32_t)0x01U<<(4)));
    }
}
# 267 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c"
void pmu_eflash_deepsleep_power_config(ControlStatus state)
{
    if(ENABLE == state) {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000008U)) &= ~((uint32_t)((uint32_t)0x01U<<(5)));
    } else {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000008U)) |= ((uint32_t)((uint32_t)0x01U<<(5)));
    }
}
...
void pmu_eflash_wakeup_time_config(uint32_t wakeup_time)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000010U)) &= ~((0xFFFFFFFFUL << (uint8_t)(21)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(28))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000010U)) |= ((wakeup_time & 0x000000FFU) << ((uint32_t)21U));
}
...
void pmu_deepsleep_wait_time_config(uint32_t wait_time)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000010U)) &= ~((0xFFFFFFFFUL << (uint8_t)(16)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(20))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000010U)) |= ((wait_time & 0x0000001FU) << ((uint32_t)16U));
}
# 311 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c"
FlagStatus pmu_flag_get(uint32_t flag)
{
    FlagStatus ret;
    if(0U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00007000U) + 0x00000004U)) & flag)) {
        ret = SET;
    }else{
        ret = RESET;
    }
...
# 331 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_pmu.c"
void pmu_flag_clear(uint32_t flag)
{
    switch(flag) {
