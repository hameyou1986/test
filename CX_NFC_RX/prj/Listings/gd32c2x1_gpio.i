# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c" 2
# 45 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
void gpio_deinit(uint32_t gpio_periph)
{
    switch(gpio_periph) {
...
# 100 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
void gpio_mode_set(uint32_t gpio_periph, uint32_t mode, uint32_t pull_up_down, uint32_t pin)
{
    uint16_t i;
    uint32_t ctl, pupd;
    ...
    for(i = 0U; i < 16U; i++) {
        if(((((uint32_t)1U << i)) & (pin & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))))) != (uint32_t)0U) {

            ctl &= ~(0x3U << (2U * (i)));

            ctl |= ((uint32_t)((uint32_t)(mode & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1))))) << (2U * (i))));


            pupd &= ~(0x3U << (2U * (i)));

            pupd |= ((uint32_t)((uint32_t)(pull_up_down & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1))))) << (2U * (i))));
        }
    }
...
# 145 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
void gpio_output_options_set(uint32_t gpio_periph, uint8_t otype, uint32_t speed, uint32_t pin)
{
    uint16_t i;
    uint32_t ospeed;

    if(((uint8_t)(0x01U)) == (otype & (uint8_t)((uint32_t)((uint32_t)0x01U<<(0))))) {
        (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x00000004U)) |= (uint32_t)(pin & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))));
    } else {
        (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x00000004U)) &= (uint32_t)(~(pin & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15))))));
    }
    ...
    for(i = 0U; i < 16U; i++) {
        if((((uint32_t)1U << i) & (pin & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))))) != (uint32_t)0U) {
            ...
            ospeed |= ((uint32_t)((uint32_t)(speed & ((uint32_t)((uint32_t)0x01U<<(0)))) << (i)));
        }
    }
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x00000008U)) = ospeed;
}
# 181 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
void gpio_bit_set(uint32_t gpio_periph, uint32_t pin)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x00000018U)) = (uint32_t)(pin & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))));
}
# 197 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
void gpio_bit_reset(uint32_t gpio_periph, uint32_t pin)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x00000028U)) = (uint32_t)(pin & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))));
}
# 217 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
void gpio_bit_write(uint32_t gpio_periph, uint32_t pin, bit_status bit_value)
{
    if(RESET != bit_value) {
        (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x00000018U)) = (uint32_t)(pin & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))));
...
# 235 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
void gpio_port_write(uint32_t gpio_periph, uint16_t data)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x00000014U)) = (uint32_t)data;
}
# 251 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
FlagStatus gpio_input_bit_get(uint32_t gpio_periph, uint32_t pin)
{
    FlagStatus reval;

    if((uint32_t)RESET != ((*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x00000010U)) & ((pin & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))))))) {
        reval = SET;
    } else {
        reval = RESET;
    }
...
# 272 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
uint16_t gpio_input_port_get(uint32_t gpio_periph)
{
    return ((uint16_t)(*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x00000010U)));
}
# 288 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
FlagStatus gpio_output_bit_get(uint32_t gpio_periph, uint32_t pin)
{
    FlagStatus reval;

    if((uint32_t)RESET != ((*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x00000014U)) & ((pin & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))))))) {
        reval = SET;
    } else {
        reval = RESET;
    }
...
# 308 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
uint16_t gpio_output_port_get(uint32_t gpio_periph)
{
    return ((uint16_t)(*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x00000014U)));
}
# 342 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
void gpio_af_set(uint32_t gpio_periph, uint32_t alt_func_num, uint32_t pin)
{
    uint16_t i;
    uint32_t afrl, afrh;
    ...
    for(i = 0U; i < 8U; i++) {
        if((((uint32_t)1U << i) & (pin & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))))) != (uint32_t)0U) {
            ...
            afrl &= ~(0xFU << (4U * (i)));
            afrl |= ((uint32_t)((uint32_t)(alt_func_num & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3))))) << (4U * (i))));
        }
    }
    ...
    for(i = 8U; i < 16U; i++) {
        if((((uint32_t)1U << i) & (pin & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))))) != (uint32_t)0U) {
            ...
            afrh &= ~(0xFU << (4U * (i - 8U)));
            afrh |= ((uint32_t)((uint32_t)(alt_func_num & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3))))) << (4U * (i - 8U))));
        }
    }
...
# 381 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
void gpio_pin_lock(uint32_t gpio_periph, uint32_t pin)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x0000001CU)) = (uint32_t)(pin & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))));
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x0000001CU)) = (uint32_t)lock;
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x0000001CU));
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x0000001CU));
}
# 405 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
void gpio_bit_toggle(uint32_t gpio_periph, uint32_t pin)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x0000002CU)) = (uint32_t)(pin & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))));
}
# 418 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_gpio.c"
void gpio_port_toggle(uint32_t gpio_periph)
{
