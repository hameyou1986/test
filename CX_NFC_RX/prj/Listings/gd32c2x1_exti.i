# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c" 2
# 45 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
void exti_deinit(void)
{

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x00U)) = ((uint32_t)0x00000000U);
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x04U)) = ((uint32_t)0x00000000U);
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x08U)) = ((uint32_t)0x00000000U);
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x0CU)) = ((uint32_t)0x00000000U);
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x10U)) = ((uint32_t)0x00000000U);
}
# 73 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
void exti_init(exti_line_enum linex, exti_mode_enum mode, exti_trig_type_enum trig_type)


{

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x00U)) &= ~(uint32_t)linex;
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x04U)) &= ~(uint32_t)linex;
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x08U)) &= ~(uint32_t)linex;
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x0CU)) &= ~(uint32_t)linex;
...
# 124 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
void exti_interrupt_enable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x00U)) |= (uint32_t)linex;
}
# 137 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
void exti_interrupt_disable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x00U)) &= ~(uint32_t)linex;
}
# 150 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
void exti_event_enable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x04U)) |= (uint32_t)linex;
}
# 163 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
void exti_event_disable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x04U)) &= ~(uint32_t)linex;
}
# 176 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
void exti_software_interrupt_enable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x10U)) |= (uint32_t)linex;
}
# 189 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
void exti_software_interrupt_disable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x10U)) &= ~(uint32_t)linex;
}
# 202 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
FlagStatus exti_flag_get(exti_line_enum linex)
{
    FlagStatus reval = RESET;

    if(0U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x14U)) & (uint32_t)linex)) {
        reval = SET;
    } else {
        reval = RESET;
    }
...
# 223 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
void exti_flag_clear(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x14U)) = (uint32_t)linex;
}
# 236 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
FlagStatus exti_interrupt_flag_get(exti_line_enum linex)
{
    FlagStatus reval = RESET;
...
# 257 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_exti.c"
void exti_interrupt_flag_clear(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010400U) + 0x14U)) = (uint32_t)linex;
}
