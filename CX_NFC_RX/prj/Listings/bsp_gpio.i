...
gpio_int_cfg_t gpio_int_cfg[]={
    {RCU_GPIOA,((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U),((uint32_t)((uint32_t)0x01U<<(4))),PUPD_PULLUP,TRIG_FALLING,((uint8_t)0x00U),((uint8_t)0x04U),EXTI_4,EXTI4_IRQn,0},
};
...
void bsp_gpio_int_init(void)
{
    ...
    for(int i=0; i< sizeof(gpio_int_cfg)/sizeof(gpio_int_cfg_t);i++)
    {
        ...
        uint32_t pull_up_down = cfg->pupd == PUPD_NONE ? (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))) & ((uint32_t)(0) << 0)):cfg->pupd == PUPD_PULLUP ? (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))) & ((uint32_t)(1) << 0)): (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))) & ((uint32_t)(2) << 0));
        gpio_mode_set(cfg->gpio_periph, (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))) & ((uint32_t)(0) << 0)), pull_up_down, cfg->gpio_pin);
...
void EXTI4_IRQHandler(void)
{
    if(RESET != exti_interrupt_flag_get(EXTI_4))
    {
        ...
        if(gpio_int_cfg[0].irq_fun)
        {
            gpio_int_cfg[0].irq_fun(0);
        }
    }
}
