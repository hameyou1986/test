# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fwdgt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fwdgt.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fwdgt.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fwdgt.c" 2
...
# 86 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fwdgt.c"
ErrStatus fwdgt_prescaler_value_config(uint16_t prescaler_value)
{
...
# 115 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fwdgt.c"
ErrStatus fwdgt_reload_value_config(uint16_t reload_value)
{
    ...
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x00000008U)) = (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) & ((uint32_t)(reload_value) << 0U));

    return reload_flag;
}
# 143 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fwdgt.c"
ErrStatus fwdgt_window_value_config(uint16_t window_value)
{
    ...
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x00000010U)) = (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) & ((uint32_t)(window_value) << 0U));
...
# 191 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fwdgt.c"
ErrStatus fwdgt_config(uint16_t reload_value, uint8_t prescaler_div)
{
...
# 233 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fwdgt.c"
FlagStatus fwdgt_flag_get(uint16_t flag)
{
    FlagStatus fwdgt_flag = RESET;

    if((uint32_t)RESET != ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x0000000CU)) & flag)) {
        fwdgt_flag = SET;
    }
