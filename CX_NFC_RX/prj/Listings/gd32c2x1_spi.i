# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c" 2
# 62 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void spi_i2s_deinit(uint32_t spi_periph)
{
    switch(spi_periph) {
...
void spi_struct_para_init(spi_parameter_struct *spi_struct)
{
...

    {
        ...
        spi_struct->frame_size = (((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) & (uint32_t)((uint32_t)(7U) << 8U));
        spi_struct->nss = ((uint32_t)0x00000000U);
        spi_struct->clock_polarity_phase = ((uint32_t)0x00000000U);
        spi_struct->prescale = (((0xFFFFFFFFUL << (uint8_t)(3)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(5)))) & (uint32_t)((uint32_t)(0U) << 3U));
        spi_struct->endian = ((uint32_t)0x00000000U);
    }
}
# 129 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
ErrStatus spi_init(uint32_t spi_periph, spi_parameter_struct *spi_struct)
{
...

    {
        ...
        if(((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph) {
            ...
            reg1 |= (spi_struct->device_mode & (((uint32_t)((uint32_t)0x01U<<(2))) | ((uint32_t)((uint32_t)0x01U<<(8)))));

            reg1 |= (spi_struct->trans_mode & ((uint32_t)0x0000C400U));

            reg1 |= (spi_struct->nss & ((uint32_t)((uint32_t)0x01U<<(9))));

            reg1 |= (spi_struct->endian & ((uint32_t)((uint32_t)0x01U<<(7))));

            reg1 |= (spi_struct->clock_polarity_phase & (((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(0)))));

            reg1 |= (spi_struct->prescale & (((0xFFFFFFFFUL << (uint8_t)(3)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(5)))) & (uint32_t)((uint32_t)(7U) << 3U)));


            if(((((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) & (uint32_t)((uint32_t)(7U) << 8U)) != spi_struct->frame_size) && ((((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) & (uint32_t)((uint32_t)(15U) << 8U)) != spi_struct->frame_size)) {
                reval = ERROR;
            } else {
                reg1 |= (uint32_t)(spi_struct->frame_size & ((uint32_t)((uint32_t)0x01U<<(11))));
            }
            ...
            reg2 |= (spi_struct->device_mode & (((uint32_t)((uint32_t)0x01U<<(2))) | ((uint32_t)((uint32_t)0x01U<<(8)))));

            reg2 |= (spi_struct->trans_mode & ((uint32_t)0x0000C400U));

            reg2 |= (spi_struct->nss & ((uint32_t)((uint32_t)0x01U<<(9))));

            reg2 |= (spi_struct->endian & ((uint32_t)((uint32_t)0x01U<<(7))));

            reg2 |= (spi_struct->clock_polarity_phase & (((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(0)))));

            reg2 |= (spi_struct->prescale & (((0xFFFFFFFFUL << (uint8_t)(3)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(5)))) & (uint32_t)((uint32_t)(7U) << 3U)));

            (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) = (uint32_t)reg2;


            reg3 |= (uint32_t)(spi_struct->frame_size & ((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))));
...
# 247 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void i2s_init(uint32_t spi_periph, uint32_t i2s_mode, uint32_t i2s_standard, uint32_t i2s_ckpl)
{
    uint32_t reg;
    ...
    reg |= (uint32_t)(i2s_mode & (((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))) & ((uint32_t)(3U) << 8U)));

    reg |= (uint32_t)(i2s_standard & ((uint32_t)0x000000B0U));

    reg |= (uint32_t)(i2s_ckpl & ((uint32_t)((uint32_t)0x01U<<(3))));


    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000001CU)) = (uint32_t)reg;
}
# 294 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
                    ...
                    uint32_t i2s_mckout)
{
...

    {
        ...
        clks = ((uint32_t)0x0000C000U);

        if(0U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x0000008CU)) & clks)) {

            clks = (uint32_t)(((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x0000008CU)) & ((uint32_t)0x0000F000U)) >> 12U);
            ...
            i2sclock = (uint32_t)((((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x0000008CU)) & ((uint32_t)0x000000F0U)) >> 4U) + 1U);

            i2sclock = (uint32_t)((((uint32_t)8000000) / i2sclock) * clks * 2U);
        } else {
        ...
        if(((uint32_t)((uint32_t)0x01U<<(9))) == i2s_mckout) {
            clks = (uint32_t)(((i2sclock / 256U) * 10U) / i2s_audiosample);
        } else {
            if((((0xFFFFFFFFUL << (uint8_t)(1)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2)))) & ((uint32_t)(0U) << 1U)) == i2s_frameformat) {
        ...
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000020U)) = (uint32_t)((i2sdiv & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7))))) | (i2sof & ((uint32_t)((uint32_t)0x01U<<(8)))) | (i2s_mckout & ((uint32_t)((uint32_t)0x01U<<(9)))));


        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000001CU)) &= (uint32_t)(~(((0xFFFFFFFFUL << (uint8_t)(1)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2)))) | ((uint32_t)((uint32_t)0x01U<<(0)))));

        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000001CU)) |= (uint32_t)(i2s_frameformat & ((((0xFFFFFFFFUL << (uint8_t)(1)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2)))) & ((uint32_t)(2U) << 1U)) | ((uint32_t)((uint32_t)0x01U<<(0)))));
    }
}
...
# 445 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void spi_dma_enable(uint32_t spi_periph, uint8_t dma)
{
...
# 464 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void spi_dma_disable(uint32_t spi_periph, uint8_t dma)
{
    if(((uint8_t)0x00U) == dma) {
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(1))));
...
# 483 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void spi_transmit_odd_config(uint32_t spi_periph, uint16_t odd)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(14))));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)(odd & ((uint32_t)((uint32_t)0x01U<<(14))));
}
# 501 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void spi_receive_odd_config(uint32_t spi_periph, uint16_t odd)
{
...
# 519 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void spi_fifo_access_size_config(uint32_t spi_periph, uint16_t fifo_access_size)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(12))));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)(fifo_access_size & ((uint32_t)((uint32_t)0x01U<<(12))));
}
# 536 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
ErrStatus spi_i2s_data_frame_format_config(uint32_t spi_periph, uint16_t frame_format)
{
    ErrStatus reval = SUCCESS;
    uint32_t reg;
    ...
    if(((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph) {
        ...
        if(((((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) & (uint32_t)((uint32_t)(7U) << 8U)) != frame_format) && ((((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) & (uint32_t)((uint32_t)(15U) << 8U)) != frame_format)) {
            reval = ERROR;
        } else {

            (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(11))));

            (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) |= ((uint32_t)frame_format & ((uint32_t)((uint32_t)0x01U<<(11))));
        }
    } else {
        reg = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U));

        reg &= (uint32_t)(~((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))));
        reg |= (uint32_t)(frame_format & ((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))));

        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) = reg;
    }
    return reval;
}
# 572 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void spi_bidirectional_transfer_config(uint32_t spi_periph, uint32_t transfer_direction)
{
...
# 590 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void spi_i2s_data_transmit(uint32_t spi_periph, uint16_t data)
{
    uint32_t reg, byten;
...
uint16_t spi_i2s_data_receive(uint32_t spi_periph)
{
    ...
    if(((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph) {
        reval = ((uint16_t)(*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000000CU)));
    } else {
...
# 643 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void spi_crc_polynomial_set(uint32_t spi_periph, uint16_t crc_poly)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000010U)) = (uint16_t)crc_poly;
}
...
uint16_t spi_crc_polynomial_get(uint32_t spi_periph)
{
    ...
    reval = ((uint16_t)(*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000010U)));
    return reval;
}
# 673 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void spi_crc_length_set(uint32_t spi_periph, uint16_t crc_length)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(11))));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) |= (uint32_t)(crc_length & ((uint32_t)((uint32_t)0x01U<<(11))));
}
...
# 724 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
uint16_t spi_crc_get(uint32_t spi_periph, uint8_t crc)
{
    uint16_t reval = 0U;

    if(((uint8_t)0x00U) == crc) {
        reval = ((uint16_t)((*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000018U))));
    } else {
        reval = ((uint16_t)((*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000014U))));
    }
    return reval;
}
...
# 867 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void spi_i2s_format_error_clear(uint32_t spi_periph, uint32_t flag)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000008U)) = (uint32_t)(~flag);
}
# 903 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
FlagStatus spi_i2s_flag_get(uint32_t spi_periph, uint32_t flag)
{
    FlagStatus reval = RESET;
    uint32_t reg = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000008U));

    switch(flag) {
# 935 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
    default:
        if(0U != (reg & flag)) {
            reval = SET;
        }
...
# 957 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void spi_i2s_interrupt_enable(uint32_t spi_periph, uint8_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)(interrupt & ((uint32_t)0x000000E0U));
}
# 974 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
void spi_i2s_interrupt_disable(uint32_t spi_periph, uint8_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) &= ~(uint32_t)(interrupt & ((uint32_t)0x000000E0U));
}
# 994 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_spi.c"
FlagStatus spi_i2s_interrupt_flag_get(uint32_t spi_periph, uint8_t interrupt)
{
    FlagStatus reval = RESET;
