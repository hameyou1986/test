# 1 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/gd32c2x1_err_report.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/gd32c2x1_err_report.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/gd32c2x1_err_report.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/gd32c2x1_err_report.c" 2



__attribute__((weak)) void fw_error_notification(void);


err_report_struct err_report_buffer[2U];

uint8_t err_report_buff_index = 0x00U;
# 54 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/gd32c2x1_err_report.c"
void fw_debug_report_err(uint16_t moduleid, uint16_t apiid, uint8_t errid)
{
    err_report_struct *debug_report_err_buffer;

    if(err_report_buff_index < 2U) {
