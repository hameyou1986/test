# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c" 2
# 61 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_deinit(uint32_t i2c_periph)
{
    switch(i2c_periph) {
    case (((uint32_t)0x40000000U) + 0x00005400U):

        i2c_disable((((uint32_t)0x40000000U) + 0x00005400U));
    ...
    case ((((uint32_t)0x40000000U) + 0x00005400U) + 0x00000400U):
        ...
        i2c_disable(((((uint32_t)0x40000000U) + 0x00005400U) + 0x00000400U));
...
# 92 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_timing_config(uint32_t i2c_periph, uint32_t psc, uint32_t scl_dely, uint32_t sda_dely)
{

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000010U)) &= ~((0xFFFFFFFFUL << (uint8_t)(28)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(31))));
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000010U)) &= ~((0xFFFFFFFFUL << (uint8_t)(20)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23))));
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000010U)) &= ~((0xFFFFFFFFUL << (uint8_t)(16)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(19))));

    psc = (uint32_t)(psc << ((uint32_t)0x0000001CU)) & ((0xFFFFFFFFUL << (uint8_t)(28)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(31))));
    scl_dely = (uint32_t)(scl_dely << ((uint32_t)0x00000014U)) & ((0xFFFFFFFFUL << (uint8_t)(20)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23))));
    sda_dely = (uint32_t)(sda_dely << ((uint32_t)0x00000010U)) & ((0xFFFFFFFFUL << (uint8_t)(16)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(19))));

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000010U)) |= (psc | scl_dely | sda_dely);
}
# 130 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_digital_noise_filter_config(uint32_t i2c_periph, uint32_t filter_length)
{

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) &= ~((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11))));

    filter_length = (uint32_t)(filter_length << ((uint32_t)0x00000008U)) & ((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11))));

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) |= filter_length;
}
...
void i2c_analog_noise_filter_enable(uint32_t i2c_periph)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) &= ~((uint32_t)((uint32_t)0x01U<<(12)));
}
...
# 170 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_master_clock_config(uint32_t i2c_periph, uint32_t sclh, uint32_t scll)
{

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000010U)) &= ~((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15))));
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000010U)) &= ~((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7))));

    sclh = (uint32_t)(sclh << ((uint32_t)0x00000008U)) & ((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15))));
    scll = (uint32_t)(scll << ((uint32_t)0x00000000U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7))));

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000010U)) |= (sclh | scll);
}
# 193 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_master_addressing(uint32_t i2c_periph, uint32_t address, uint32_t trans_direction)
{

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000004U)) &= ~((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9))));
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000004U)) |= (uint32_t)(address & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))));

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000004U)) &= ~((uint32_t)((uint32_t)0x01U<<(10)));
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000004U)) |= (uint32_t)(trans_direction & ((uint32_t)((uint32_t)0x01U<<(10))));
}
...
# 324 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_address_config(uint32_t i2c_periph, uint32_t address, uint32_t addr_format)
{

    address = address & ((uint32_t)0x000003FFU);
    addr_format = addr_format & ((uint32_t)((uint32_t)0x01U<<(10)));
...
# 349 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_address_bit_compare_config(uint32_t i2c_periph, uint32_t compare_bits)
{

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000090U)) &= ~((0xFFFFFFFFUL << (uint8_t)(9)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15))));

    compare_bits = (compare_bits << ((uint32_t)0x00000009U)) & ((0xFFFFFFFFUL << (uint8_t)(9)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15))));
...
# 387 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_second_address_config(uint32_t i2c_periph, uint32_t address, uint32_t addr_mask)
{

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x0000000CU)) &= ~((0xFFFFFFFFUL << (uint8_t)(1)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7))));
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x0000000CU)) |= (uint32_t)(address & ((0xFFFFFFFFUL << (uint8_t)(1)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7)))));

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x0000000CU)) &= ~((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(10))));
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x0000000CU)) |= (uint32_t)(addr_mask << ((uint32_t)0x00000008U)) & ((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(10))));
...
uint32_t i2c_received_address_get(uint32_t i2c_periph)
{
    return (uint32_t)(((*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000018U)) & ((0xFFFFFFFFUL << (uint8_t)(17)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23))))) >> ((uint32_t)0x00000011U));
}
...
void i2c_wakeup_from_deepsleep_enable(uint32_t i2c_periph)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(18)));
}
...
# 527 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_data_transmit(uint32_t i2c_periph, uint8_t data)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000028U)) = (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7)))) & (uint32_t)data);
}
...
uint8_t i2c_data_receive(uint32_t i2c_periph)
{
    return (uint8_t)((*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000024U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7)))));
}
...
# 572 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_transfer_byte_number_config(uint32_t i2c_periph, uint8_t byte_number)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000004U)) &= (uint32_t)(~((0xFFFFFFFFUL << (uint8_t)(16)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23)))));
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000004U)) |= (uint32_t)((uint32_t)byte_number << ((uint32_t)0x00000010U));
}
# 588 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_dma_enable(uint32_t i2c_periph, uint8_t dma)
{
    if(((uint32_t)0x00000000U) == dma) {
        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(14)));
    } else if(((uint32_t)0x00000001U) == dma) {
        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(15)));
    } else {

    }
}
# 609 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_dma_disable(uint32_t i2c_periph, uint8_t dma)
{
    if(((uint32_t)0x00000000U) == dma) {
        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) &= ~((uint32_t)((uint32_t)0x01U<<(14)));
...
uint32_t i2c_pec_value_get(uint32_t i2c_periph)
{
    return ((*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000020U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7)))));
}
...
# 781 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_bus_timeout_b_config(uint32_t i2c_periph, uint32_t timeout)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000014U)) &= ~((0xFFFFFFFFUL << (uint8_t)(16)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(27))));
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000014U)) |= (uint32_t)(timeout << ((uint32_t)0x00000010U)) & ((0xFFFFFFFFUL << (uint8_t)(16)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(27))));
}
# 794 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_bus_timeout_a_config(uint32_t i2c_periph, uint32_t timeout)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000014U)) &= ~((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11))));
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000014U)) |= (uint32_t)(timeout & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))));
}
# 810 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_idle_clock_timeout_config(uint32_t i2c_periph, uint32_t timeout)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000014U)) &= ~((uint32_t)((uint32_t)0x01U<<(12)));
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000014U)) |= timeout & ((uint32_t)((uint32_t)0x01U<<(12)));
}
# 840 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
FlagStatus i2c_flag_get(uint32_t i2c_periph, uint32_t flag)
{
    FlagStatus reval = RESET;

    if(0U != ((*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000018U)) & flag)) {
        reval = SET;
    } else {
...
# 870 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_flag_clear(uint32_t i2c_periph, uint32_t flag)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x0000001CU)) |= (flag & ((uint32_t)0x00003F38U));
}
# 890 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_interrupt_enable(uint32_t i2c_periph, uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) |= (interrupt & ((uint32_t)0x000000FEU));
}
# 910 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_interrupt_disable(uint32_t i2c_periph, uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) &= ~(interrupt & ((uint32_t)0x000000FEU));
}
# 936 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
FlagStatus i2c_interrupt_flag_get(uint32_t i2c_periph, i2c_interrupt_flag_enum int_flag)
{
    FlagStatus reval = RESET;
    uint32_t ret1;
...
# 973 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_i2c.c"
void i2c_interrupt_flag_clear(uint32_t i2c_periph, i2c_interrupt_flag_enum int_flag)
{
