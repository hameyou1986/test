# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c" 2
# 53 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_deinit(dma_channel_enum channelx)
{

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) &= ~((uint32_t)((uint32_t)0x01U<<(0)));

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) = ((uint32_t)0x00000000U);
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x0000000CU) + 0x14U * (uint32_t)(channelx))) = ((uint32_t)0x00000000U);
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000010U) + 0x14U * (uint32_t)(channelx))) = ((uint32_t)0x00000000U);
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000014U) + 0x14U * (uint32_t)(channelx))) = ((uint32_t)0x00000000U);
...
void dma_struct_para_init(dma_parameter_struct *init_struct)
{
...

    {
        ...
        init_struct->priority = (uint32_t)(((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(13)))) & ((0U) << 12));
        init_struct->request = (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(5)))) & ((0U) << 0));
    }
}
# 146 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_init(dma_channel_enum channelx, dma_parameter_struct *init_struct)
{
...

    {
        ...
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000010U) + 0x14U * (uint32_t)(channelx))) = init_struct->periph_addr;


        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000014U) + 0x14U * (uint32_t)(channelx))) = init_struct->memory_addr;


        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x0000000CU) + 0x14U * (uint32_t)(channelx))) = (init_struct->number & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))));


        ctl = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx)));
        ctl &= ~(((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))) | ((0xFFFFFFFFUL << (uint8_t)(10)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) | ((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(13)))));
        ctl |= ((init_struct->memory_width & ((0xFFFFFFFFUL << (uint8_t)(10)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11))))) | (init_struct->periph_width & ((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))) ) | (init_struct->priority & ((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(13))))));
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) = ctl;


        if(((uint8_t)0x01U) == init_struct->periph_inc) {
            (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) |= ((uint32_t)((uint32_t)0x01U<<(6)));
        } else {
            (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) &= ~((uint32_t)((uint32_t)0x01U<<(6)));
        }
        ...
        if(((uint8_t)0x01U) == init_struct->memory_inc) {
            (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) |= ((uint32_t)((uint32_t)0x01U<<(7)));
        } else {
            (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) &= ~((uint32_t)((uint32_t)0x01U<<(7)));
        }
        ...
        if(((uint8_t)0x00U) == init_struct->direction) {
            (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) &= ~((uint32_t)((uint32_t)0x01U<<(4)));
        } else {
            (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) |= ((uint32_t)((uint32_t)0x01U<<(4)));
        }

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) &= ~((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(5))));
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) |= (init_struct->request & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(5)))));
    }
}
# 206 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_circulation_enable(dma_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) |= ((uint32_t)((uint32_t)0x01U<<(5)));
}
# 219 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_circulation_disable(dma_channel_enum channelx)
{

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) &= ~((uint32_t)((uint32_t)0x01U<<(5)));
}
# 233 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_memory_to_memory_enable(dma_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) |= ((uint32_t)((uint32_t)0x01U<<(14)));
}
# 246 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_memory_to_memory_disable(dma_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) &= ~((uint32_t)((uint32_t)0x01U<<(14)));
}
# 259 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_channel_enable(dma_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) |= ((uint32_t)((uint32_t)0x01U<<(0)));
}
# 272 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_channel_disable(dma_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) &= ~((uint32_t)((uint32_t)0x01U<<(0)));
}
# 286 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_periph_address_config(dma_channel_enum channelx, uint32_t address)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000010U) + 0x14U * (uint32_t)(channelx))) = address;
}
# 300 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_memory_address_config(dma_channel_enum channelx, uint32_t address)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000014U) + 0x14U * (uint32_t)(channelx))) = address;
}
# 315 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_transfer_number_config(dma_channel_enum channelx, uint32_t number)
{
     (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x0000000CU) + 0x14U * (uint32_t)(channelx))) = (number & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))));
}
# 328 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
uint32_t dma_transfer_number_get(dma_channel_enum channelx)
{
    uint32_t reval ;
    reval = (uint32_t)(*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x0000000CU) + 0x14U * (uint32_t)(channelx)));
    return reval;
}
# 349 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_priority_config(dma_channel_enum channelx, uint32_t priority)
{
    uint32_t ctl;
    ...
    ctl &= ~((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(13))));
    ctl |= (priority & ((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(13)))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) = ctl;
}
# 374 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_memory_width_config(dma_channel_enum channelx, uint32_t mwidth)
{
    uint32_t ctl;
    ...
    ctl &= ~((0xFFFFFFFFUL << (uint8_t)(10)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11))));
    ctl |= (mwidth & ((0xFFFFFFFFUL << (uint8_t)(10)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) = ctl;
}
# 398 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_periph_width_config(dma_channel_enum channelx, uint32_t pwidth)
{
    uint32_t ctl;
    ...
    ctl &= ~((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9))));
    ctl |= (pwidth & ((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) = ctl;
}
# 417 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_memory_increase_enable(dma_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) |= ((uint32_t)((uint32_t)0x01U<<(7)));
}
# 430 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_memory_increase_disable(dma_channel_enum channelx)
{

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) &= ~((uint32_t)((uint32_t)0x01U<<(7)));
}
# 444 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_periph_increase_enable(dma_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) |= ((uint32_t)((uint32_t)0x01U<<(6)));
}
# 457 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_periph_increase_disable(dma_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) &= ~((uint32_t)((uint32_t)0x01U<<(6)));
}
# 474 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_transfer_direction_config(dma_channel_enum channelx, uint32_t direction)
{
...
# 498 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
FlagStatus dma_flag_get(dma_channel_enum channelx, uint32_t flag)
{
    FlagStatus reval = RESET;
    if((uint32_t)RESET != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000000U)) & ((flag) << ((uint32_t)(channelx) * 4U)))) {
        reval = SET;
    } else {
        reval = RESET;
    }
...
# 523 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_flag_clear(dma_channel_enum channelx, uint32_t flag)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000004U)) |= ((flag) << ((uint32_t)(channelx) * 4U));
}
# 541 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
FlagStatus dma_interrupt_flag_get(dma_channel_enum channelx, uint32_t int_flag)
{
    FlagStatus reval = RESET;
    ...
    switch(int_flag) {
        case ((uint32_t)((uint32_t)0x01U<<(1))):
            interrupt_flag = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000000U)) & ((int_flag) << ((uint32_t)(channelx) * 4U));
            interrupt_enable = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) & ((uint32_t)((uint32_t)0x01U<<(1)));
            break;
        case ((uint32_t)((uint32_t)0x01U<<(2))):
            interrupt_flag = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000000U)) & ((int_flag) << ((uint32_t)(channelx) * 4U));
            interrupt_enable = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) & ((uint32_t)((uint32_t)0x01U<<(2)));
            break;
        case ((uint32_t)((uint32_t)0x01U<<(3))):
            interrupt_flag = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000000U)) & ((int_flag) << ((uint32_t)(channelx) * 4U));
            interrupt_enable = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) & ((uint32_t)((uint32_t)0x01U<<(3)));
            break;
        default:
            break;
    }
...
# 584 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_interrupt_flag_clear(dma_channel_enum channelx, uint32_t int_flag)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000004U)) |= ((int_flag) << ((uint32_t)(channelx) * 4U));
}
# 602 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_interrupt_enable(dma_channel_enum channelx, uint32_t source)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) |= source & ((uint32_t)0x0000001EU);
}
# 620 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dma_interrupt_disable(dma_channel_enum channelx, uint32_t source)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00000008U) + 0x14U * (uint32_t)(channelx))) &= ~source & ((uint32_t)0x0000001EU);
}
...
void dmamux_sync_struct_para_init(dmamux_sync_parameter_struct *init_struct)
{
...

    {
        ...
        init_struct->sync_id = (((0xFFFFFFFFUL << (uint8_t)(24)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(28)))) & ((16U) << 24));
        init_struct->sync_polarity = (((0xFFFFFFFFUL << (uint8_t)(17)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(18)))) & ((1U) << 17));
        init_struct->request_number = 1U;
    }
}
# 662 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_synchronization_init(dmamux_multiplexer_channel_enum channelx,
                                 dmamux_sync_parameter_struct *init_struct)
{
...

    {
        ...
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) &= ~(((uint32_t)((uint32_t)0x01U<<(16))) | ((uint32_t)((uint32_t)0x01U<<(9))));


        cfg = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx)));
        cfg &= ~(((0xFFFFFFFFUL << (uint8_t)(24)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(28)))) | ((0xFFFFFFFFUL << (uint8_t)(19)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23)))) | ((0xFFFFFFFFUL << (uint8_t)(17)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(18)))));
        cfg |= ((init_struct->sync_polarity & ((0xFFFFFFFFUL << (uint8_t)(17)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(18))))) | (init_struct->sync_id & ((0xFFFFFFFFUL << (uint8_t)(24)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(28))))) | (((0xFFFFFFFFUL << (uint8_t)(19)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23)))) & ((init_struct->request_number - 1U) << 19)));
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) = cfg;
    }
}
# 691 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_synchronization_enable(dmamux_multiplexer_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) |= ((uint32_t)((uint32_t)0x01U<<(16)));
}
# 704 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_synchronization_disable(dmamux_multiplexer_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) &= (~((uint32_t)((uint32_t)0x01U<<(16))));
}
# 716 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_event_generation_enable(dmamux_multiplexer_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) |= ((uint32_t)((uint32_t)0x01U<<(9)));
}
# 729 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_event_generation_disable(dmamux_multiplexer_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) &= (~((uint32_t)((uint32_t)0x01U<<(9))));
}
...
void dmamux_gen_struct_para_init(dmamux_gen_parameter_struct *init_struct)
{
...

    {
        ...
        init_struct->trigger_id = (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(4)))) & ((0U) << 0));
        init_struct->trigger_polarity = (((0xFFFFFFFFUL << (uint8_t)(17)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(18)))) & ((1U) << 17));
        init_struct->request_number = 1U;
    }
}
# 771 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_request_generator_init(dmamux_generator_channel_enum channelx,
                                   dmamux_gen_parameter_struct *init_struct)
{
...

    {
        ...
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U) + 0x00000100U) + 0x04U * (uint32_t)(channelx))) &= ~(((uint32_t)((uint32_t)0x01U<<(16))));


        cfg = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U) + 0x00000100U) + 0x04U * (uint32_t)(channelx)));
        cfg &= ~(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(4)))) | ((0xFFFFFFFFUL << (uint8_t)(19)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23)))) | ((0xFFFFFFFFUL << (uint8_t)(17)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(18)))));
        cfg |= ((((0xFFFFFFFFUL << (uint8_t)(19)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23)))) & ((init_struct->request_number - 1U) << 19)) | (init_struct->trigger_id & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(4))))) |
        (init_struct->trigger_polarity & ((0xFFFFFFFFUL << (uint8_t)(17)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(18))))));
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U) + 0x00000100U) + 0x04U * (uint32_t)(channelx))) = cfg;
    }
}
# 801 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_request_generator_channel_enable(dmamux_generator_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U) + 0x00000100U) + 0x04U * (uint32_t)(channelx))) |= ((uint32_t)((uint32_t)0x01U<<(16)));
}
# 814 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_request_generator_channel_disable(dmamux_generator_channel_enum channelx)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U) + 0x00000100U) + 0x04U * (uint32_t)(channelx))) &= (~((uint32_t)((uint32_t)0x01U<<(16))));
}
# 833 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_synchronization_polarity_config(dmamux_multiplexer_channel_enum channelx,
                                            uint32_t polarity)
{

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) &= ~((0xFFFFFFFFUL << (uint8_t)(17)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(18))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) |= (polarity & ((0xFFFFFFFFUL << (uint8_t)(17)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(18)))));
}
# 852 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_request_forward_number_config(dmamux_multiplexer_channel_enum channelx, uint32_t number)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) &= ~((0xFFFFFFFFUL << (uint8_t)(19)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) |= (((0xFFFFFFFFUL << (uint8_t)(19)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23)))) & ((number - 1U) << 19)) & ((0xFFFFFFFFUL << (uint8_t)(19)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23))));
}
# 889 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_sync_id_config(dmamux_multiplexer_channel_enum channelx, uint32_t id)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) &= ~((0xFFFFFFFFUL << (uint8_t)(24)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(28))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) |= (uint32_t)(id & ((uint32_t)0x0000001FU));
}
# 940 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_request_id_config(dmamux_multiplexer_channel_enum channelx, uint32_t id)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) &= ~((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(5))));
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U)) + 0x04U * (uint32_t)(channelx))) |= (id & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(5)))));
}
# 960 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_trigger_polarity_config(dmamux_generator_channel_enum channelx, uint32_t polarity)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U) + 0x00000100U) + 0x04U * (uint32_t)(channelx))) &= ~((0xFFFFFFFFUL << (uint8_t)(17)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(18))));
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U) + 0x00000100U) + 0x04U * (uint32_t)(channelx))) |= (polarity & ((0xFFFFFFFFUL << (uint8_t)(17)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(18)))));
}
# 977 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_request_generate_number_config(dmamux_generator_channel_enum channelx, uint32_t number)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U) + 0x00000100U) + 0x04U * (uint32_t)(channelx))) &= ~((0xFFFFFFFFUL << (uint8_t)(19)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23))));
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U) + 0x00000100U) + 0x04U * (uint32_t)(channelx))) |= (((0xFFFFFFFFUL << (uint8_t)(19)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23)))) & (((number - 1U) & ((0xFFFFFFFFUL << (uint8_t)(19)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23))))) << 19));
}
# 1013 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_trigger_id_config(dmamux_generator_channel_enum channelx, uint32_t id)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U) + 0x00000100U) + 0x04U * (uint32_t)(channelx))) &= ~((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(4))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00000800U) + 0x00000100U) + 0x04U * (uint32_t)(channelx))) |= (id & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(4)))));
}
# 1033 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
FlagStatus dmamux_flag_get(dmamux_flag_enum flag)
{
    FlagStatus reval = RESET;
    if((uint32_t)RESET != (((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00000800U) + (((uint32_t)(flag) & 0x0000FFFFU) >> 6)))) & ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(flag) & 0x1FU)))))) {
        reval = SET;
    } else {
        reval = RESET;
    }
...
# 1058 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_flag_clear(dmamux_flag_enum flag)
{
    ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00000800U) + (((uint32_t)(flag) & 0x0000FFFFU) >> 6) + 0x4U))) = ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(flag) & 0x1FU))));
}
# 1077 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
FlagStatus dmamux_interrupt_flag_get(dmamux_interrupt_flag_enum int_flag)
{
    FlagStatus reval = RESET;
    uint32_t intenable, flagstatus ;

    intenable = (((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00000800U) + ((uint32_t)(int_flag) >> 22)))) & ((uint32_t)((uint32_t)0x01U<<((((uint32_t)(int_flag) & 0x001F0000U) >> 16)))));

    flagstatus = (((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00000800U) + (((uint32_t)(int_flag) & 0x0000FFFFU) >> 6)))) & ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(int_flag) & 0x1FU)))));
...
# 1108 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_interrupt_flag_clear(dmamux_interrupt_flag_enum int_flag)
{
    ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00000800U) + (((uint32_t)(int_flag) & 0x0000FFFFU) >> 6) + 0x4U))) = ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(int_flag) & 0x1FU))));
}
# 1127 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_interrupt_enable(dmamux_interrupt_enum interrupt)
{
    ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00000800U) + (((uint32_t)(interrupt) & 0x0000FFFFU) >> 6)))) |= ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(interrupt) & 0x1FU))));
}
# 1146 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dma.c"
void dmamux_interrupt_disable(dmamux_interrupt_enum interrupt)
{
    ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00000800U) + (((uint32_t)(interrupt) & 0x0000FFFFU) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(interrupt) & 0x1FU))));
}
