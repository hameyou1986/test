# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dbg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dbg.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dbg.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dbg.c" 2
# 46 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dbg.c"
void dbg_deinit(void)
{
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + 0x00000004U)) = ((uint32_t)0x00000000U);
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + 0x00000008U)) = ((uint32_t)0x00000000U);
}
...
uint32_t dbg_id_get(void)
{
    return (*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + 0x00000000U));
}
# 73 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dbg.c"
void dbg_low_power_enable(uint32_t dbg_low_power)
{
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + 0x00000004U)) |= (dbg_low_power & ((uint32_t)0x00000007U));
}
# 88 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dbg.c"
void dbg_low_power_disable(uint32_t dbg_low_power)
{
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + 0x00000004U)) &= ~(dbg_low_power & ((uint32_t)0x00000007U));
}
# 110 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dbg.c"
void dbg_periph_enable(dbg_periph_enum dbg_periph)
{
    ((*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + ((uint32_t)(dbg_periph) >> 6)))) |= ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(dbg_periph) & 0x1FU))));
}
# 132 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_dbg.c"
void dbg_periph_disable(dbg_periph_enum dbg_periph)
{
    ((*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + ((uint32_t)(dbg_periph) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(dbg_periph) & 0x1FU))));
}
