# 1 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/system_gd32c2x1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/system_gd32c2x1.c" 2
# 36 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/system_gd32c2x1.c"
...
# 37 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/system_gd32c2x1.c" 2
# 66 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/system_gd32c2x1.c"
uint32_t SystemCoreClock = ((((uint32_t)48000000)));
static void system_clock_irc48m(void);
# 79 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/system_gd32c2x1.c"
static void system_clock_config(void);
# 89 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/system_gd32c2x1.c"
void SystemInit(void)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x0000008CU)) &= ~(((0xFFFFFFFFUL << (uint8_t)(9)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(12)))) | ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))) | ((0xFFFFFFFFUL << (uint8_t)(7)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(8)))));
    ...
    nvic_vector_table_set(((uint32_t)0x08000000), (uint32_t)0x00000000U);
...
# 192 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/system_gd32c2x1.c"
static void system_clock_irc48m(void)
{
    uint32_t timeout = 0U;
    uint32_t stab_flag = 0U;

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000000U)) =((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000000U)) & (~((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2)))))) | (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2)))) & ((uint32_t)(1)));


    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));

    rcu_irc48mdiv_sys_clock_config((((0xFFFFFFFFUL << (uint8_t)(29)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(31)))) & ((uint32_t)(2) << 29U)));
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00000008U)) |= (((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7)))) & ((uint32_t)(0) << 4U));

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00000008U)) |= (((0xFFFFFFFFUL << (uint8_t)(11)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(13)))) & ((uint32_t)(0) << 11U));


    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00000008U)) &= ~((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00000008U)) |= (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))) & ((uint32_t)(0) << 0U));


    while(((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00000008U)) & ((0xFFFFFFFFUL << (uint8_t)(2)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3))))) != (((0xFFFFFFFFUL << (uint8_t)(2)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))) & ((uint32_t)(0) << 2U))) {
    }
}
# 311 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/system_gd32c2x1.c"
void SystemCoreClockUpdate(void)
{
    ...
    case 0x00:
        irc48mdiv_sys = ((((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00000000U))) & ((0xFFFFFFFFUL << (uint8_t)((29))) & (0xFFFFFFFFUL >> (31U - (uint8_t)((31)))))) >> (29));
        SystemCoreClock = ((uint32_t)48000000) / (1 << irc48mdiv_sys);
        break;
    ...
    case 0x02:
        SystemCoreClock = ((uint32_t)32000);
        break;
    ...
    default:
        SystemCoreClock = ((uint32_t)48000000)/4;
        break;
    }
...
# 356 "../std/GD32C2x1_Firmware_Library/CMSIS/GD/GD32C2x1/Source/system_gd32c2x1.c"
