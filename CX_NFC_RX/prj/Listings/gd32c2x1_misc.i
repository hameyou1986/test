# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_misc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_misc.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_misc.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_misc.c" 2
# 47 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_misc.c"
void nvic_irq_enable(IRQn_Type nvic_irq, uint8_t nvic_irq_priority)
{

    __NVIC_SetPriority(nvic_irq, ((uint32_t)nvic_irq_priority & ((uint32_t)0x00000003U)));
...
# 75 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_misc.c"
void nvic_vector_table_set(uint32_t nvic_vict_tab, uint32_t offset)
{
...
# 103 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_misc.c"
void system_lowpower_set(uint8_t lowpower_mode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= ((uint32_t)lowpower_mode & ((uint32_t)0x00000016U));
}
# 119 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_misc.c"
void system_lowpower_reset(uint8_t lowpower_mode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR &= ~((uint32_t)lowpower_mode & ((uint32_t)0x00000016U));
}
# 133 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_misc.c"
void systick_clksource_set(uint32_t systick_clksource)
{
