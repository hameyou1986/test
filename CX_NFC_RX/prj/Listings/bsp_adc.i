...
void rcu_config(void)
{
    ...
    rcu_adc_clock_config((uint32_t)0x00000000U, (((0xFFFFFFFFUL << (uint8_t)(9)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(12)))) & ((uint32_t)(11) << 9U)));
}
# 42 "../bsp/bsp_adc.c"
void adc_gpio_config(void)
{
    ...
    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))) & ((uint32_t)(3) << 0)), (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(0))));
    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))) & ((uint32_t)(3) << 0)), (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(1))));
}
void adc_config(void)
{

    adc_special_function_config(((uint32_t)((uint32_t)0x01U<<(1))), DISABLE);

    adc_special_function_config(((uint32_t)((uint32_t)0x01U<<(8))), ENABLE);

    adc_data_alignment_config(((uint32_t)0x00000000U));

    adc_channel_length_config(((uint8_t)0x02U), 2);



    adc_inserted_channel_config(0U, ((uint8_t)0x00U), (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2)))) & ((uint32_t)(7) << 0)));
    adc_inserted_channel_config(1U, ((uint8_t)0x01U), (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2)))) & ((uint32_t)(7) << 0)));


    adc_external_trigger_source_config(((uint8_t)0x02U), (((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(14)))) & ((uint32_t)(7) << 12)));
    adc_external_trigger_config(((uint8_t)0x02U), ENABLE);


    adc_internal_channel_config(((uint32_t)((uint32_t)0x01U<<(23))), ENABLE);
    adc_internal_channel_config(((uint32_t)((uint32_t)0x01U<<(24))), ENABLE);
...
void adc_channel_sample(void)
{
    ...
    while( (adc_flag_get(((uint32_t)((uint32_t)0x01U<<(2)))) == RESET) || (adc_flag_get(((uint32_t)((uint32_t)0x01U<<(1)))) == RESET) );


    value[0]=adc_inserted_data_read(((uint8_t)0x00U));
    value[1]=adc_inserted_data_read(((uint8_t)0x01U));
