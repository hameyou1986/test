# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c" 2
# 50 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_deinit(uint32_t timer_periph)
{
    switch(timer_periph) {
...
void timer_struct_para_init(timer_parameter_struct *initpara)
{
...

    {
        ...
        initpara->alignedmode = ((uint16_t)(((0xFFFFFFFFUL << (uint8_t)(5)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))) & ((uint32_t)(0) << 5U)));
        initpara->counterdirection = ((uint16_t)0x0000U);
        initpara->period = 65535U;
        initpara->clockdivision = ((uint16_t)(((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))) & ((uint32_t)(0) << 8U)));
        initpara->repetitioncounter = 0U;
    }
}
# 120 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_init(uint32_t timer_periph, timer_parameter_struct *initpara)
{
...

    {
        ...
        if((((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U) == timer_periph) || (((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U) == timer_periph)) {
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x00U)) &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(4))) | ((0xFFFFFFFFUL << (uint8_t)(5)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6))))));
        ...
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x00U)) &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x00U)) |= (uint32_t)((initpara->clockdivision) &((uint32_t)0x00000300U));

        if((((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U) == timer_periph) || (((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014400U) == timer_periph) || (((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014800U) == timer_periph)){
...
# 232 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_counter_alignment(uint32_t timer_periph, uint16_t aligned)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x00U)) &= (uint32_t)(~((0xFFFFFFFFUL << (uint8_t)(5)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))));
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x00U)) |= (uint32_t)(aligned & ((uint32_t)0x00000060U));
}
...
# 271 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_prescaler_config(uint32_t timer_periph, uint16_t prescaler, uint32_t pscreload)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x28U)) = (uint32_t)prescaler;

    if(((uint32_t)0x00000000U) == pscreload) {
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x14U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
    }
}
# 287 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_repetition_value_config(uint32_t timer_periph, uint16_t repetition)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x30U)) = (uint32_t)repetition;
}
# 299 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_autoreload_value_config(uint32_t timer_periph, uint16_t autoreload)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x2CU)) = (uint32_t)autoreload;
}
# 311 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_counter_value_config(uint32_t timer_periph, uint16_t counter)
{
...
uint16_t timer_counter_read(uint32_t timer_periph)
{
    ...
    count_value = (uint16_t)((*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x24U)));
    return (count_value);
}
...
# 352 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_single_pulse_mode_config(uint32_t timer_periph, uint32_t spmode)
{
    if(((uint32_t)0x00000000U) == spmode) {
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x00U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(3)));
        } else if(((uint32_t)0x00000001U) == spmode) {
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x00U)) &= ~((uint32_t)((uint32_t)((uint32_t)0x01U<<(3))));
        } else {

        }
}
# 373 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_update_source_config(uint32_t timer_periph, uint32_t update)
{
    if(((uint32_t)0x00000000U) == update) {
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x00U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(2)));
        } else if(((uint32_t)0x00000001U) == update) {
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x00U)) &= ~(uint32_t)((uint32_t)((uint32_t)0x01U<<(2)));
        } else {

        }
}
# 399 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_dma_enable(uint32_t timer_periph, uint16_t dma)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x0CU)) |= ((uint32_t) dma & 0X5F00U);
}
# 419 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_dma_disable(uint32_t timer_periph, uint16_t dma)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x0CU)) &= (~((uint32_t)dma & 0X5F00U));
}
# 434 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_dma_request_source_select(uint32_t timer_periph, uint32_t dma_request)
{
    if(((uint32_t)0x00000000U) == dma_request) {
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(3)));
    } else if(((uint32_t)0x00000001U) == dma_request) {
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) &= ~(uint32_t)((uint32_t)((uint32_t)0x01U<<(3)));
    } else {

    }
}
# 476 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_dma_transfer_config(uint32_t timer_periph, uint32_t dma_baseaddr, uint32_t dma_lenth)
{
    uint32_t ctl;
    ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x48U));
    ctl &= (~(uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(4)))) | ((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(12))))));
    ctl |= (uint32_t)((uint32_t)(dma_baseaddr & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(4))))) | (dma_lenth & ((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(12))))));
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x48U)) = ctl;
}
# 502 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_event_software_generate(uint32_t timer_periph, uint32_t event)
{
...
void timer_break_struct_para_init(timer_break_parameter_struct* breakpara)
{
...

    {
        ...
        breakpara->protectmode = ((uint16_t)(((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))) & ((uint32_t)(0) << 8U)));
        breakpara->break0state = ((uint32_t)0x0000U);
        breakpara->break0filter = 0U;
        breakpara->break0polarity = ((uint32_t)0x00000000U);
        breakpara->break1state = ((uint32_t)0x00000000U);
        breakpara->break1filter = 0U;
        breakpara->break1polarity = ((uint32_t)0x00000000U);
    }
}
# 554 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_break_config(uint32_t timer_periph, timer_break_parameter_struct* breakpara)
{
...

    {
        ...
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x44U)) = ((((uint32_t)(breakpara->runoffstate) &((uint16_t)((uint32_t)((uint32_t)0x01U<<(11))))))|
                                              (((uint32_t)(breakpara->ideloffstate) &((uint16_t)((uint32_t)((uint32_t)0x01U<<(10))))))|
                                              (((uint32_t)(breakpara->deadtime)&((uint32_t)0x000000FFU)))|
                                              (((uint32_t)(breakpara->outputautostate) &((uint16_t)((uint32_t)((uint32_t)0x01U<<(14))))))|
                                              (((uint32_t)(breakpara->break0state) &((uint32_t)((uint32_t)((uint32_t)0x01U<<(12)))))) |
                                              (((uint32_t)(breakpara->break0filter << 16U)&((uint32_t)0x000F0000U))) |
                                              (((uint32_t)(breakpara->break0polarity) &((uint32_t)((uint32_t)((uint32_t)0x01U<<(13))))))|
                                              (((uint32_t)(breakpara->break1state) &((uint32_t)((uint32_t)((uint32_t)0x01U<<(24)))))) |
                                              (((uint32_t)(breakpara->break1filter << 20U)&((uint32_t)0x00F00000U))) |
                                              (((uint32_t)(breakpara->break1polarity) & ((uint32_t)((uint32_t)((uint32_t)0x01U<<(25))))))|
                                              (((uint32_t)(breakpara->protectmode)&((uint16_t)(((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))) & ((uint32_t)(3) << 8U)))))) ;
        } else if((((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014400U) == timer_periph) || (((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014800U) == timer_periph)) {
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x44U)) = ((((uint32_t)(breakpara->runoffstate) &((uint16_t)((uint32_t)((uint32_t)0x01U<<(11))))))|
                                              (((uint32_t)(breakpara->ideloffstate) &((uint16_t)((uint32_t)((uint32_t)0x01U<<(10))))))|
                                              (((uint32_t)(breakpara->deadtime)&((uint32_t)0x000000FFU)))|
                                              (((uint32_t)(breakpara->outputautostate) &((uint16_t)((uint32_t)((uint32_t)0x01U<<(14))))))|
...
# 599 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_break_enable(uint32_t timer_periph, uint16_t break_num)
{
    if(((uint16_t)0x0000U) == break_num) {
      (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x44U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(12)));
    } else if(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U) == timer_periph) {
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x44U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(24)));
    } else {

    }
}
# 620 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_break_disable(uint32_t timer_periph, uint16_t break_num)
{
    if(((uint16_t)0x0000U) == break_num) {
      (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x44U)) &= ~(uint32_t)((uint32_t)((uint32_t)0x01U<<(12)));
...
# 660 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_primary_output_config(uint32_t timer_periph, ControlStatus newvalue)
{
    if(ENABLE == newvalue){
...
# 676 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_control_shadow_config(uint32_t timer_periph, ControlStatus newvalue)
{
    if(ENABLE == newvalue){
...
# 695 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_control_shadow_update_config(uint32_t timer_periph, uint32_t ccuctl)
{
        if(((uint32_t)0x00000000U) == ccuctl){
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(2))));
        }else if(((uint32_t)0x00000001U) == ccuctl){
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(2)));
        }else{
...
# 750 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_output_config(uint32_t timer_periph, uint16_t channel, timer_oc_parameter_struct *ocpara)
{
    uint32_t ctl;
...

    {
        ...
        case ((uint16_t)0x0000U):
            ...
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) &= ~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1))));

            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= ((uint32_t)ocpara->outputstate & ((uint16_t)0x0001U));

            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
            ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(1))));
            ctl |= ((uint32_t)ocpara->ocpolarity & ((uint32_t)((uint32_t)0x01U<<(1))));
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
            if((((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U) == timer_periph) || (((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014400U) == timer_periph) || (((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014800U) == timer_periph)){

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(2))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (uint32_t)(ocpara->outputnstate & ((uint32_t)((uint32_t)0x01U<<(2))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(3))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (uint32_t)(ocpara->ocnpolarity & ((uint32_t)((uint32_t)0x01U<<(3))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(8))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) |= (uint32_t)(ocpara->ocidlestate & ((uint32_t)((uint32_t)0x01U<<(8))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(9))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) |= (uint32_t)(ocpara->ocnidlestate & ((uint32_t)((uint32_t)0x01U<<(9))));
            }
            break;
        ...
        case ((uint16_t)0x0001U):
            ...
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) &= ~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9))));

            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (((uint32_t)ocpara->outputstate & ((uint16_t)0x0001U)) << 4U);

            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
            ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(5))));
            ctl |= (uint32_t)(((uint32_t)ocpara->ocpolarity & ((uint32_t)((uint32_t)0x01U<<(1)))) << 4U);
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
            if(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U) == timer_periph){

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(6))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (uint32_t)((uint32_t)(ocpara->outputnstate & ((uint32_t)((uint32_t)0x01U<<(2)))) << 4U);

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(7))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (uint32_t)((uint32_t)(ocpara->ocnpolarity & ((uint32_t)((uint32_t)0x01U<<(3)))) << 4U);

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(10))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) |= (uint32_t)((uint32_t)(ocpara->ocidlestate & ((uint32_t)((uint32_t)0x01U<<(8)))) << 2U);

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(11))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) |= (uint32_t)((uint32_t)(ocpara->ocnidlestate & ((uint32_t)((uint32_t)0x01U<<(9)))) << 2U);
            }
            break;
        ...
        case ((uint16_t)0x0002U):
            ...
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x1CU)) &= ~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1))));

            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (((uint32_t)ocpara->outputstate & ((uint16_t)0x0001U)) << 8U);

            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
            ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(9))));
            ctl |= (((uint32_t)ocpara->ocpolarity & ((uint32_t)((uint32_t)0x01U<<(1)))) << 8U);
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
            if(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U) == timer_periph){

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(10))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (uint32_t)((uint32_t)(ocpara->outputnstate & ((uint32_t)((uint32_t)0x01U<<(2)))) << 8U);

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(11))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (uint32_t)((uint32_t)(ocpara->ocnpolarity & ((uint32_t)((uint32_t)0x01U<<(3)))) << 8U);

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(12))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) |= (uint32_t)((uint32_t)(ocpara->ocidlestate & ((uint32_t)((uint32_t)0x01U<<(8)))) << 4U);

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(13))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) |= (uint32_t)((uint32_t)(ocpara->ocnidlestate & ((uint32_t)((uint32_t)0x01U<<(9)))) << 4U);
            }
            break;
        ...
        case ((uint16_t)0x0003U):
            ...
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x1CU)) &= ~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9))));

            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (((uint32_t)ocpara->outputstate & ((uint16_t)0x0001U)) << 12U);

            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
            ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(13))));
            ctl |= (((uint32_t)ocpara->ocpolarity & ((uint32_t)((uint32_t)0x01U<<(1)))) << 12U);
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
            if(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U) == timer_periph){

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(14))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) |= (uint32_t)((uint32_t)(ocpara->ocidlestate & ((uint32_t)((uint32_t)0x01U<<(8)))) << 6U);
            }
            break;

        case ((uint16_t)0x0004U):
            if(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U) == timer_periph){

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &=(~(uint32_t)((uint32_t)((uint32_t)0x01U<<(16))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (((uint32_t)ocpara->outputstate & ((uint16_t)0x0001U)) << 16U);

                ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
                ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(17))));
                ctl |= (((uint32_t)ocpara->ocpolarity & ((uint32_t)((uint32_t)0x01U<<(1)))) << 16U);
                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(16))));

                (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) |= (uint32_t)((uint32_t)(ocpara->ocidlestate & ((uint32_t)((uint32_t)0x01U<<(8)))) << 8U);
            }
            break;
        default:
            break;
...
# 925 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_output_mode_config(uint32_t timer_periph, uint16_t channel, uint32_t ocmode)
{
    uint32_t ctl;
    switch(channel) {
    ...
    case ((uint16_t)0x0000U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
        ctl &= (~(uint32_t)(((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))) | ((uint32_t)((uint32_t)0x01U<<(16)))));
        ctl |= (uint32_t)(ocmode&(((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))) | ((uint32_t)((uint32_t)0x01U<<(16)))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
        break;

    case ((uint16_t)0x0001U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
        ctl &= (~(uint32_t)(((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(14)))) | ((uint32_t)((uint32_t)0x01U<<(24)))));
        ctl |= (uint32_t)((uint32_t)(ocmode&(((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))) | ((uint32_t)((uint32_t)0x01U<<(16))))) << 8U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
        break;

    case ((uint16_t)0x0002U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x1CU));
        ctl &= (~(uint32_t)(((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))) | ((uint32_t)((uint32_t)0x01U<<(16)))));
        ctl |= (uint32_t)(ocmode&(((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))) | ((uint32_t)((uint32_t)0x01U<<(16)))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x1CU)) = ctl;
        break;
    ...
    case ((uint16_t)0x0004U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x54U));
        ctl &= (~(uint32_t)(((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))) | ((uint32_t)((uint32_t)0x01U<<(16)))));
        ctl |= (uint32_t)(ocmode&(((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))) | ((uint32_t)((uint32_t)0x01U<<(16)))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x54U)) = ctl;
        break;
    default:
        break;
    }
}
# 984 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_combined_3_phase_pwm_config(uint32_t timer_periph, uint16_t channel, uint32_t state)
{
    uint32_t ctl;
    switch(channel) {
    ...
    case ((uint16_t)0x0000U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x58U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(29))));
        ctl |= (uint32_t)((state & ((uint16_t)0x0001U)) << 29U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x58U)) = ctl;
        break;
    case ((uint16_t)0x0001U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x58U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(30))));
        ctl |= (uint32_t)((state & ((uint16_t)0x0001U)) << 30U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x58U)) = ctl;
        break;
    case ((uint16_t)0x0002U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x58U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(31))));
        ctl |= (uint32_t)((state & ((uint16_t)0x0001U)) << 31U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x58U)) = ctl;
        break;
    default:
        break;
...
# 1026 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_output_pulse_value_config(uint32_t timer_periph, uint16_t channel, uint32_t pulse)
{
    switch(channel) {
    ...
    case ((uint16_t)0x0004U):
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x58U)) = (uint32_t)(pulse & 0xFFFFU);
        break;
    default:
        break;
    }
}
# 1071 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_output_shadow_config(uint32_t timer_periph, uint16_t channel, uint16_t ocshadow)
{
    uint32_t ctl;
    switch(channel) {
    ...
    case ((uint16_t)0x0000U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(3))));
        ctl |= ((uint32_t)ocshadow & ((uint16_t)0x0008U));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
        break;

    case ((uint16_t)0x0001U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(11))));
        ctl |= (((uint32_t)ocshadow & ((uint16_t)0x0008U)) << 8U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
        break;
...
# 1132 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_output_fast_config(uint32_t timer_periph, uint16_t channel, uint16_t ocfast)
{
    uint32_t ctl;
    switch(channel) {
    ...
    case ((uint16_t)0x0000U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(2))));
        ctl |= ((uint32_t)ocfast & ((uint16_t)0x0004));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
        break;

    case ((uint16_t)0x0001U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(10))));
        ctl |= (((uint32_t)ocfast & ((uint16_t)0x0004)) << 8U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
        break;
...
# 1193 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_output_clear_config(uint32_t timer_periph, uint16_t channel, uint16_t occlear)
{
    uint32_t ctl;
    switch(channel) {
    ...
    case ((uint16_t)0x0000U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(7))));
        ctl |= ((uint32_t)occlear & ((uint16_t)0x0080U));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
        break;

    case ((uint16_t)0x0001U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(15))));
        ctl |= (((uint32_t)occlear & ((uint16_t)0x0080U)) << 8U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
        break;
...
# 1254 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_output_polarity_config(uint32_t timer_periph, uint16_t channel, uint16_t ocpolarity)
{
    uint32_t ctl;
    switch(channel) {
    ...
    case ((uint16_t)0x0000U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(1))));
        ctl |= ((uint32_t)ocpolarity & ((uint32_t)((uint32_t)0x01U<<(1))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
        break;
    ...
    case ((uint16_t)0x0001U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(5))));
        ctl |= (((uint32_t)ocpolarity & ((uint32_t)((uint32_t)0x01U<<(1)))) << 4U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
        break;
    ...
    case ((uint16_t)0x0002U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(9))));
        ctl |= (((uint32_t)ocpolarity & ((uint32_t)((uint32_t)0x01U<<(1)))) << 8U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
        break;
    ...
    case ((uint16_t)0x0003U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(13))));
        ctl |= (((uint32_t)ocpolarity & ((uint32_t)((uint32_t)0x01U<<(1)))) << 12U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
        break;
    ...
    case ((uint16_t)0x0004U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(17))));
        ctl |= (((uint32_t)ocpolarity & ((uint32_t)((uint32_t)0x01U<<(1)))) << 16U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
        break;
    default:
        break;
...
# 1313 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_complementary_output_polarity_config(uint32_t timer_periph, uint16_t channel, uint16_t ocnpolarity)
{
    switch(channel){
    ...
    case ((uint16_t)0x0000U):
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(3))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (uint32_t)(ocnpolarity & ((uint32_t)((uint32_t)0x01U<<(3))));
        break;

    case ((uint16_t)0x0001U):
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(7))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (uint32_t)((uint32_t)(ocnpolarity & ((uint32_t)((uint32_t)0x01U<<(3)))) << 4U);
        break;

    case ((uint16_t)0x0002U):
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(11))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (uint32_t)((uint32_t)(ocnpolarity & ((uint32_t)((uint32_t)0x01U<<(3)))) << 8U);
        break;
    default:
        break;
    }
}
# 1353 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_output_state_config(uint32_t timer_periph, uint16_t channel, uint32_t state)
{
    uint32_t ctl;
    switch(channel) {
    ...
    case ((uint16_t)0x0000U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(0))));
        ctl |= (uint32_t)(state & ((uint32_t)((uint32_t)0x01U<<(0))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
        break;

    case ((uint16_t)0x0001U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(4))));
        ctl |= (uint32_t)((uint32_t)(state & ((uint32_t)((uint32_t)0x01U<<(0)))) << 4U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
        break;

    case ((uint16_t)0x0002U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(8))));
        ctl |= (uint32_t)((uint32_t)(state & ((uint32_t)((uint32_t)0x01U<<(0)))) << 8U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
        break;

    case ((uint16_t)0x0003U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(12))));
        ctl |= (uint32_t)((uint32_t)(state & ((uint32_t)((uint32_t)0x01U<<(0)))) << 12U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
        break;

    case ((uint16_t)0x0004U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
        ctl &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(16))));
        ctl |= (uint32_t)((uint32_t)(state & ((uint32_t)((uint32_t)0x01U<<(0)))) << 16U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
        break;
    default:
        break;
...
# 1413 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_complementary_output_state_config(uint32_t timer_periph, uint16_t channel, uint16_t ocnstate)
{
    switch(channel){
    ...
    case ((uint16_t)0x0000U):
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(2))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= ((uint32_t)ocnstate & ((uint16_t)0x0004U));
        break;

    case ((uint16_t)0x0001U):
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(6))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (((uint32_t)ocnstate & ((uint16_t)0x0004U)) << 4U);
        break;

    case ((uint16_t)0x0002U):
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(10))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) |= (uint32_t)(((uint32_t)ocnstate & ((uint16_t)0x0004U)) << 8U);
        break;
    default:
        break;
    }
...
# 1475 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_input_capture_config(uint32_t timer_periph, uint16_t channel, timer_ic_parameter_struct *icpara)
{
    uint32_t ctl;
...

    {
        ...
        case ((uint16_t)0x0000U):
            ...
            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
            ctl &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(3)))));
            ctl |= (((uint32_t)icpara->icpolarity) & ((uint16_t)0x000AU));
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;

            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
            ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))));
            ctl |= (uint32_t)((icpara->icselection) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))));
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;

            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
            ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7)))));
        ...
        case ((uint16_t)0x0001U):
            ...
            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
            ctl &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(5))) | ((uint32_t)((uint32_t)0x01U<<(7)))));
            ctl |= (((uint32_t)(icpara->icpolarity) & ((uint16_t)0x000AU)) << 4U);
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;

            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
            ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))));
            ctl |= (uint32_t)((uint32_t)((icpara->icselection) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1))))) << 8U);
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;

            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
            ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))));
        ...
        case ((uint16_t)0x0002U):
            ...
            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
            ctl &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(9))) | ((uint32_t)((uint32_t)0x01U<<(11)))));
            ctl |= ((((uint32_t)icpara->icpolarity) & ((uint16_t)0x000AU)) << 8U);
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;

            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x1CU));
            ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))));
            ctl |= (uint32_t)((uint32_t)((icpara->icselection) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1))))));
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x1CU)) = ctl;
        ...
        case ((uint16_t)0x0003U):
            ...
            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
            ctl &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(13))) | ((uint32_t)((uint32_t)0x01U<<(15)))));
            ctl |= ((((uint32_t)icpara->icpolarity) & ((uint16_t)0x000AU)) << 12U);
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
...
# 1604 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_channel_input_capture_prescaler_config(uint32_t timer_periph, uint16_t channel, uint16_t prescaler)
{
    uint32_t ctl;
    switch(channel) {
    ...
    case ((uint16_t)0x0000U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
        ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(2)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))));
        ctl |= ((uint32_t)prescaler & ((0xFFFFFFFFUL << (uint8_t)(2)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
        break;

    case ((uint16_t)0x0001U):
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
        ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(10)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))));
        ctl |= (((uint32_t)prescaler & ((0xFFFFFFFFUL << (uint8_t)(2)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3))))) << 8U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
        break;
...
# 1653 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
uint16_t timer_channel_capture_value_register_read(uint32_t timer_periph, uint16_t channel)
{
    uint16_t count_value = 0U;
    switch(channel) {
    ...
    case ((uint16_t)0x0000U):
        count_value = (uint16_t)(*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x34U));
        break;

    case ((uint16_t)0x0001U):
        count_value = (uint16_t)(*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x38U));
        break;

    case ((uint16_t)0x0002U):
        count_value = (uint16_t)(*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x3CU));
        break;

    case ((uint16_t)0x0003U):
        count_value = (uint16_t)(*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x40U));
        break;
    default:
        break;
    }
...
# 1694 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_input_pwm_capture_config(uint32_t timer_periph, uint16_t channel, timer_ic_parameter_struct *icpwm)
{
    uint32_t ctl;
...

    {
        ...
        if(((uint16_t)0x0000U) == channel) {
            ...
            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
            ctl &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(3)))));
            ctl |= (((uint32_t)icpwm->icpolarity) & ((uint16_t)0x000AU));
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;

            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
            ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))));
            ctl |= (uint32_t)((icpwm->icselection) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))));
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
            ...
            timer_channel_input_capture_prescaler_config(timer_periph, ((uint16_t)0x0000U), (uint16_t)((icpwm->icprescaler) & ((uint16_t)0x000CU)));
            ...
            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
            ctl &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(5))) | ((uint32_t)((uint32_t)0x01U<<(7)))));
            ctl |= (((uint32_t)icpolarity & ((uint16_t)0x000AU)) << 4U);
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;


            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
            ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))));
            ctl |= (((uint32_t)icselection & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1))))) << 8U);
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
            ...
            timer_channel_input_capture_prescaler_config(timer_periph, ((uint16_t)0x0001U), (uint16_t)((icpwm->icprescaler) & ((uint16_t)0x000CU)));
        } else {
            ...
            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
            ctl &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(5))) | ((uint32_t)((uint32_t)0x01U<<(7)))));
            ctl |= ((((uint32_t)icpwm->icpolarity) & ((uint16_t)0x000AU)) << 4U);
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;

            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
            ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))));
            ctl |= ((((uint32_t)icpwm->icselection) &((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1))))) << 8U);
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
            ...
            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
            ctl &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(3)))));
            ctl |= ((uint32_t)icpolarity & ((uint16_t)0x000AU));
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;

            ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
            ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))));
            ctl |= ((uint32_t)icselection & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))));
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
...
# 1824 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_hall_mode_config(uint32_t timer_periph, uint32_t hallmode)
{
    if(((uint32_t)0x00000000U) == hallmode) {
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(7)));
    } else {
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) &= ~(uint32_t)((uint32_t)((uint32_t)0x01U<<(7)));
    }
}
# 1849 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_input_trigger_source_select(uint32_t timer_periph, uint32_t intrigger)
{
    ...
    switch(timer_periph){
    case ((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U):
        TIMERxCFG_addr0 = &(*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x110U));
        TIMERxCFG_addr1 = &(*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x114U));
        break;
    case ((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U):
        TIMERxCFG_addr0 = &(*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x118U));
        TIMERxCFG_addr1 = &(*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x11CU));
        break;
    default:
        break;
    }
    TIMERxCFG_temp0 = (*(volatile uint32_t *)(uint32_t)(TIMERxCFG_addr0));
    TIMERxCFG_temp1 = (*(volatile uint32_t *)(uint32_t)(TIMERxCFG_addr1));
    if((TIMERxCFG_temp0 & 0xFFFFFFFFU) == 0U){
        TIMERxCFG_temp1 = (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2)))) & intrigger);
        (*(volatile uint32_t *)(uint32_t)(TIMERxCFG_addr1)) = TIMERxCFG_temp1;
    }else{
        for(i = 0U; i < 8U; i++){
          if((TIMERxCFG_temp0 & (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))) << (i * 4U))) != 0U){
              break;
          }
        }
        TIMERxCFG_temp0 = ((((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))) << (i * 4U)) & ((uint32_t)(intrigger) << (i * 4U)));
        (*(volatile uint32_t *)(uint32_t)(TIMERxCFG_addr0)) = TIMERxCFG_temp0;
    }
}
# 1898 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_master_output_trigger_source_select(uint32_t timer_periph, uint32_t outtrigger)
{
    uint32_t ctl;
    ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U));
    ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))));
    ctl |= (uint32_t)(outtrigger & ((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))));
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x04U)) = ctl;
}
# 1925 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_slave_mode_select(uint32_t timer_periph, uint32_t slavemode)
{
    uint32_t TIMERxCFG_temp0 = 0U,TIMERxCFG_temp1 = 0U;
    volatile uint32_t *TIMERxCFG_addr0, *TIMERxCFG_addr1;
    ...
    if((((TIMERxCFG_temp0 & 0xFFFFFFFFU) == 0U)&&(((TIMERxCFG_temp1 & 0xFFFFFFFFU)) == 0U))){
        if(slavemode == ((uint8_t)0x08U)){
            (*(volatile uint32_t *)(uint32_t)(TIMERxCFG_addr1)) = ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2))));
        }else{
            (*(volatile uint32_t *)(uint32_t)(TIMERxCFG_addr0)) = 0x7U << (slavemode * 4U);
        }
    }else if((TIMERxCFG_temp0 & 0xFFFFFFFFU) == 0U){
        if(slavemode != ((uint8_t)0x08U)){
            trigger_temp = (TIMERxCFG_temp1 & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2)))));
            TIMERxCFG_temp0 = trigger_temp << (slavemode * 4U);
            (*(volatile uint32_t *)(uint32_t)(TIMERxCFG_addr0)) = TIMERxCFG_temp0;
            (*(volatile uint32_t *)(uint32_t)(TIMERxCFG_addr1)) = 0U;
        }
    }else{
        for(i = 0U; i < 8U; i++){
            if((TIMERxCFG_temp0 & (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2)))) << (i * 4U))) != 0U){
                trigger_temp = (TIMERxCFG_temp0 & (((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2)))) << (i * 4U))) >> (i * 4U);
                break;
            }
        }
        if(slavemode != ((uint8_t)0x08U)){
            ...
            (*(volatile uint32_t *)(uint32_t)(TIMERxCFG_addr0)) = 0U;
            (*(volatile uint32_t *)(uint32_t)(TIMERxCFG_addr1)) = TIMERxCFG_temp1;
        }
    }
}
# 1987 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_master_slave_mode_config(uint32_t timer_periph, uint32_t masterslave)
{
    if(((uint32_t)0x00000000U) == masterslave) {
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x08U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(7)));
    } else if(((uint32_t)0x00000001U) == masterslave) {
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x08U)) &= ~(uint32_t)((uint32_t)((uint32_t)0x01U<<(7)));
    } else {

    }
}
# 2015 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_external_trigger_config(uint32_t timer_periph, uint32_t extprescaler, uint32_t extpolarity, uint32_t extfilter)
{
    uint32_t ctl;
    ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x08U));
    ctl &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(15))) | ((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(13)))) | ((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11))))));
    ctl |= (uint32_t)((extprescaler & (((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(13)))) & ((uint32_t)(3) << 12U))) | (extpolarity & ((uint32_t)((uint32_t)0x01U<<(15)))));
    ctl |= (((uint32_t)extfilter & 0xFU) << 8U);
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x08U)) = ctl;
}
# 2046 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_quadrature_decoder_mode_config(uint32_t timer_periph, uint32_t decomode, uint16_t ic0polarity, uint16_t ic1polarity)
{
    uint32_t ctl;
    ...
    ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
    ctl &= (uint32_t)(((~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))))) & ((~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))))));
    ctl |= (uint32_t)(((uint16_t)0x0001U) | ((uint32_t)((uint16_t)0x0001U) << 8U));
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;

    ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
    ctl &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(3)))));
    ctl &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(5))) | ((uint32_t)((uint32_t)0x01U<<(7)))));
    ctl |= (((uint32_t)ic0polarity & ((uint16_t)0x000AU)) | (((uint32_t)ic1polarity &((uint16_t)0x000AU)) << 4U));
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;
}
...
void timer_internal_clock_config(uint32_t timer_periph)
{
    timer_slave_mode_select(timer_periph, ((uint8_t)0x08U));
}
# 2087 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_internal_trigger_as_external_clock_config(uint32_t timer_periph, uint32_t intrigger)
{

    timer_input_trigger_source_select(timer_periph, intrigger);

    timer_slave_mode_select(timer_periph, ((uint8_t)0x06U));
}
# 2112 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_external_trigger_as_external_clock_config(uint32_t timer_periph, uint32_t extrigger, uint16_t extpolarity, uint32_t extfilter)
{
    uint32_t ctl;
    if(((uint8_t)0x06U) == extrigger) {

        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(4))));

        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
        ctl &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(5))) | ((uint32_t)((uint32_t)0x01U<<(7)))));
        ctl |= (((uint32_t)extpolarity & ((uint16_t)0x000AU)) << 4U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;

        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
        ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(9)))));
        ctl |= ((uint32_t)((uint16_t)0x0001U) << 8U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
        ...
        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U));
        ctl &= (~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(3)))));
        ctl |= ((uint32_t)extpolarity & ((uint16_t)0x000AU));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x20U)) = ctl;

        ctl = (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U));
        ctl &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(1)))));
        ctl |= (uint32_t)((uint16_t)0x0001U);
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x18U)) = ctl;
...
# 2179 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_external_clock_mode0_config(uint32_t timer_periph, uint32_t extprescaler, uint32_t extpolarity, uint32_t extfilter)
{

    timer_external_trigger_config(timer_periph, ((uint32_t)extprescaler & (((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(13)))) & ((uint32_t)(3) << 12U))), ((uint32_t)extpolarity & ((uint32_t)((uint32_t)0x01U<<(15)))), ((uint32_t)extfilter & 0xFU));

    timer_slave_mode_select(timer_periph, ((uint8_t)0x06U));

    timer_input_trigger_source_select(timer_periph, ((uint8_t)0x07U));
}
# 2206 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_external_clock_mode1_config(uint32_t timer_periph, uint32_t extprescaler, uint32_t extpolarity, uint32_t extfilter)
{

    timer_external_trigger_config(timer_periph, ((uint32_t)extprescaler & (((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(13)))) & ((uint32_t)(3) << 12U))), ((uint32_t)extpolarity & ((uint32_t)((uint32_t)0x01U<<(15)))), (extfilter & 0xFU));
...
# 2239 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_input_selection_config(uint32_t timer_periph, uint16_t channel, uint16_t insel)
{
    if(((uint16_t)0x0000U) == channel) {
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x68U)) &= ~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x68U)) |= (uint32_t) (insel & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))));
    }else{
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x68U)) &= ~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x68U)) |= (uint32_t) ((uint32_t)(insel & ((0xFFFFFFFFUL << (uint8_t)(8)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11))))) << 8U);
    }
}
# 2259 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_write_chxval_register_config(uint32_t timer_periph, uint16_t ccsel)
{
    if(((uint16_t)0x0002U) == ccsel) {
...
# 2280 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_output_value_selection_config(uint32_t timer_periph, uint16_t outsel)
{
    if(((uint16_t)0x0001U) == outsel) {
...
# 2302 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_break_external_source_config(uint32_t timer_periph, uint16_t break_num, ControlStatus newvalue)
{
    if(ENABLE == newvalue) {
        if(((uint16_t)0x0000U) == break_num) {
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x60U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));
        } else if(((uint16_t)0x0001U) == break_num) {
            (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x64U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));
        } else {
...
# 2337 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_break_external_polarity_config(uint32_t timer_periph, uint16_t break_num, uint16_t bkinpolarity)
{
    if(((uint16_t)0x0000U) == break_num) {
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x60U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(9))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x60U)) |= (((uint32_t)bkinpolarity &((uint16_t)0x0001U)) << 9U);
    }else{
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x64U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(9))));
        (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x64U)) |= (((uint32_t)bkinpolarity &((uint16_t)0x0001U)) << 9U);
    }
}
# 2361 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_eti_source_selection_config(uint32_t timer_periph, uint32_t eti_source)
{
   (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x60U)) &= (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(14)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(17)))));
   (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x60U)) |= ((uint32_t)eti_source &((0xFFFFFFFFUL << (uint8_t)(14)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(17)))));
}
# 2390 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
FlagStatus timer_flag_get(uint32_t timer_periph, uint32_t flag)
{
    FlagStatus timer_flag = RESET;
    if((uint32_t)RESET != ((*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x10U)) & flag)) {
        timer_flag = SET;
    } else {
        timer_flag = RESET;
    }
...
# 2422 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_flag_clear(uint32_t timer_periph, uint32_t flag)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x10U)) = (~(uint32_t)flag);
}
# 2443 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_interrupt_enable(uint32_t timer_periph, uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x0CU)) |= (uint32_t) (interrupt & 0xFFU);
}
# 2464 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_interrupt_disable(uint32_t timer_periph, uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x0CU)) &= (~(uint32_t)(interrupt & 0xFFU));
}
# 2487 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
FlagStatus timer_interrupt_flag_get(uint32_t timer_periph, uint32_t int_flag)
{
    FlagStatus timer_interrupt_flag = RESET;
        uint32_t val;
    if( int_flag != ((uint32_t)((uint32_t)0x01U<<(8))) ) {
      val = ((*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x0CU)) & int_flag);
    }
    else {
      val = ((*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x0CU)) & ((uint32_t)((uint32_t)0x01U<<(7))) );
    }
    if(((uint32_t)RESET != ((*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x10U)) & int_flag)) && ((uint32_t)RESET != val)) {
...
# 2523 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_timer.c"
void timer_interrupt_flag_clear(uint32_t timer_periph, uint32_t int_flag)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x10U)) = (~(uint32_t)int_flag);
}
