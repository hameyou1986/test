# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c" 2
# 49 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
void syscfg_deinit(void)
{
    rcu_periph_reset_enable(RCU_SYSCFGRST);
    rcu_periph_reset_disable(RCU_SYSCFGRST);
}
# 70 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
void syscfg_i2c_fast_mode_plus_enable(uint32_t syscfg_gpio)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x00U)) |= (syscfg_gpio & (0x01DF0000U));
}
# 90 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
void syscfg_i2c_fast_mode_plus_disable(uint32_t syscfg_gpio)
{

  (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x00U)) &= (uint32_t)(~(syscfg_gpio & (0x01DF0000U)));

}
# 106 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
void syscfg_pin_remap_enable(uint32_t remap_pin)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x00U)) |= (remap_pin & (0x00000018U));
}
# 120 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
void syscfg_pin_remap_disable(uint32_t remap_pin)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x00U)) &= ~(remap_pin & (0x00000018U));
}
# 134 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
uint8_t syscfg_bootmode_get(void)
{

    uint8_t temp = (uint8_t)((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x00U)) & 0x00000003U);

    return temp;
}
# 153 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
void syscfg_exti_line_config(uint8_t exti_port, uint8_t exti_pin)
{
    uint32_t clear_exti_mask = ~((uint32_t)((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))) << ((((uint8_t)(0x04U)) * ((exti_pin) % ((uint8_t)(0x04U))))));
    uint32_t config_exti_mask = ((uint32_t)exti_port) << ((((uint8_t)(0x04U)) * ((exti_pin) % ((uint8_t)(0x04U)))));

    switch(exti_pin / ((uint8_t)(0x04U))) {
        case ((uint8_t)0x00U):

            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x08U)) &= clear_exti_mask;

            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x08U)) |= config_exti_mask;
            break;
        case ((uint8_t)0x01U):

            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x0CU)) &= clear_exti_mask;

            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x0CU)) |= config_exti_mask;
            break;
        case ((uint8_t)0x02U):

            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x10U)) &= clear_exti_mask;

            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x10U)) |= config_exti_mask;
            break;
        case ((uint8_t)0x03U):

            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x14U)) &= clear_exti_mask;

            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x14U)) |= config_exti_mask;
            break;
        default:
            break;
        }
}
# 197 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
void syscfg_lockup_enable(uint32_t lockup)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x18U)) |= (lockup & (0x00000003U));
}
...
{
    uint32_t error_bits;
    error_bits = (uint32_t)(((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x28U)) & ((0xFFFFFFFFUL << (uint8_t)(10)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15))))) >> 10U);
    return error_bits;
}
...
{
    uint32_t addr;
    addr = (uint32_t)(((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x28U)) & ((0xFFFFFFFFUL << (uint8_t)(20)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(31)))))>> 20U);
    return addr;
}
...
{
    uint32_t reg;
    reg = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x100U)) & (~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7)))));
    reg |= (uint32_t)((((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7)))) & ((uint32_t)(irq_latency & 0xFFU) << 0U)));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x100U)) = (uint32_t)reg;
}
# 253 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
void syscfg_interrupt_enable(uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x28U)) |= (interrupt & (0x0000001FU));
}
# 269 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
void syscfg_interrupt_disable(uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x28U)) &= ~(interrupt & (0x0000001FU));
}
# 283 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
FlagStatus syscfg_interrupt_flag_get(uint32_t flag)
{
    FlagStatus interrupt_flag;


    if( 0U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x1CU)) & (flag & (0x00000003U)))) {
        interrupt_flag = SET;
    } else {
...
# 306 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_syscfg.c"
void syscfg_interrupt_flag_clear(uint32_t flag)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x1CU)) = (flag & (0x00000003U));
}
