...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../app/gd32c2x1_it.c" 2
# 37 "../app/gd32c2x1_it.c"
...
{
    if(SET == syscfg_interrupt_flag_get(((uint32_t)((uint32_t)0x01U<<(0))))) {
        do{}while(1);
    } else if(SET == syscfg_interrupt_flag_get(((uint32_t)((uint32_t)0x01U<<(1))))) {
        do{}while(1);
    } else {
