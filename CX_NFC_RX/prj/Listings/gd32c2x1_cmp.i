# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c" 2
# 45 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
void cmp_deinit(cmp_enum cmp_periph)
{
    if(CMP0 == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U)) &= ((uint32_t)0x00000000U);
    }else if(CMP1 == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000004U)) &= ((uint32_t)0x00000000U);
    }else{

    }
}
# 83 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
void cmp_mode_init(cmp_enum cmp_periph, uint32_t operating_mode, uint32_t inverting_input, uint32_t output_hysteresis)
{
    uint32_t temp;
    ...
    if(CMP0 == cmp_periph){
        ...
        temp = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U));
        temp &= ~(uint32_t)(((0xFFFFFFFFUL << (uint8_t)(2)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))) | ((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))) | ((0xFFFFFFFFUL << (uint8_t)(16)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(17)))));
        temp |= (uint32_t)((operating_mode & ((0xFFFFFFFFUL << (uint8_t)(2)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3))))) | (inverting_input & ((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6))))) | (output_hysteresis & ((0xFFFFFFFFUL << (uint8_t)(16)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(17))))));
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U)) = temp;
    }else if(CMP1 == cmp_periph){

        temp = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000004U));
        temp &= ~(uint32_t)(((0xFFFFFFFFUL << (uint8_t)(2)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))) | ((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))) | ((0xFFFFFFFFUL << (uint8_t)(16)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(17)))));
        temp |= (uint32_t)((operating_mode & ((0xFFFFFFFFUL << (uint8_t)(2)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3))))) | (inverting_input & ((0xFFFFFFFFUL << (uint8_t)(4)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6))))) | (output_hysteresis & ((0xFFFFFFFFUL << (uint8_t)(16)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(17))))));
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000004U)) = temp;
    }else{

    }
}
# 115 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
void cmp_output_init(cmp_enum cmp_periph, uint32_t output_polarity)
{
    uint32_t temp;
    ...
    if(CMP0 == cmp_periph){
        ...
        if((((uint32_t)((uint32_t)0x01U<<(15))) & ((uint32_t)(1) << 15U)) == output_polarity){
            temp |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(15)));
        }else{
            temp &= ~(uint32_t)((uint32_t)((uint32_t)0x01U<<(15)));
        }
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U)) = temp;
...
# 158 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
void cmp_blanking_init(cmp_enum cmp_periph, uint32_t blanking_source_selection)
{
    uint32_t temp;
    ...
    if(CMP0 == cmp_periph){
        temp = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U));
        temp &= ~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(18)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(20))));
        temp |= (uint32_t)(blanking_source_selection & ((0xFFFFFFFFUL << (uint8_t)(18)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(20)))));
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U)) = temp;
    }else if(CMP1 == cmp_periph){
        temp = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000004U));
        temp &= ~(uint32_t)((0xFFFFFFFFUL << (uint8_t)(18)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(20))));
...
# 185 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
void cmp_enable(cmp_enum cmp_periph)
{
    if(CMP0 == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
    }else if(CMP1 == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
    }else{

    }
}
# 204 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
void cmp_disable(cmp_enum cmp_periph)
{
    if(CMP0 == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U)) &= ~(uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
...
# 223 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
void cmp_switch_enable(cmp_enum cmp_periph)
{
    if(CMP0 == cmp_periph){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(11)));
    }else if(CMP1 == cmp_periph){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(11)));
    }else{

    }
}
# 244 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
void cmp_switch_disable(cmp_enum cmp_periph)
{
    if(CMP0 == cmp_periph){
...
# 265 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
void cmp_lock_enable(cmp_enum cmp_periph)
{
    if(CMP0 == cmp_periph){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(31)));
    }else if(CMP1 == cmp_periph){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(31)));
    }else{

    }
}
# 286 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
void cmp_voltage_scaler_enable(cmp_enum cmp_periph)
{
    if(CMP0 == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(23)));
    }else if(CMP1 == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(23)));
    }else{

    }
}
# 305 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
void cmp_voltage_scaler_disable(cmp_enum cmp_periph)
{
    if(CMP0 == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U)) &= ~(uint32_t)((uint32_t)((uint32_t)0x01U<<(23)));
...
# 324 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
void cmp_scaler_bridge_enable(cmp_enum cmp_periph)
{
    if(CMP0 == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(22)));
    }else if(CMP1 == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(22)));
    }else{

    }
}
# 343 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
void cmp_scaler_bridge_disable(cmp_enum cmp_periph)
{
    if(CMP0 == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U)) &= ~(uint32_t)((uint32_t)((uint32_t)0x01U<<(22)));
...
# 362 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_cmp.c"
uint32_t cmp_output_level_get(cmp_enum cmp_periph)
{
    uint32_t reval = ((uint32_t)0x00000000U);

    if(CMP0 == cmp_periph){

        if((uint32_t)RESET != ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000000U)) & ((uint32_t)((uint32_t)0x01U<<(30))))) {
            reval = ((uint32_t)0x00000001U);
        }
    }else{

        if((uint32_t)RESET != ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00017C00U)) + 0x00000004U)) & ((uint32_t)((uint32_t)0x01U<<(30))))) {
            reval = ((uint32_t)0x00000001U);
        }
    }
    return reval;
