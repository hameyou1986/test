# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_crc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_crc.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_crc.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_crc.c" 2
# 48 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_crc.c"
void crc_deinit(void)
{
...
void crc_init_data_register_write(uint32_t init_data)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00003000U)) + 0x00000010U)) = init_data;
}
...
void crc_reverse_output_data_disable(void)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00003000U)) + 0x00000008U)) &= ~((uint32_t)((uint32_t)0x01U<<(7)));
}
...
# 139 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_crc.c"
void crc_input_data_reverse_config(uint32_t data_reverse)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00003000U)) + 0x00000008U)) &= ~((0xFFFFFFFFUL << (uint8_t)(5)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00003000U)) + 0x00000008U)) |= (uint32_t)(data_reverse & ((0xFFFFFFFFUL << (uint8_t)(5)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6)))));
}
...
# 167 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_crc.c"
void crc_polynomial_size_set(uint32_t poly_size)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00003000U)) + 0x00000008U)) &= ~((0xFFFFFFFFUL << (uint8_t)(3)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(4))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00003000U)) + 0x00000008U)) |= (uint32_t)(poly_size & ((0xFFFFFFFFUL << (uint8_t)(3)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(4)))));
}
...
void crc_polynomial_set(uint32_t poly)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00003000U)) + 0x00000014U)) &= ~((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(31))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00003000U)) + 0x00000014U)) = poly;
}
# 196 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_crc.c"
uint32_t crc_single_data_calculate(uint32_t sdata, uint8_t data_format)
{
    ...
    crc_val = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00003000U)) + 0x00000000U));

    return crc_val;
}
# 224 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_crc.c"
uint32_t crc_block_data_calculate(void *array, uint32_t size, uint8_t data_format)
{
    uint32_t data;
    uint32_t index;
...

    {
        ...
        if(0U == data_format) {
            for(index = 0U; index < size; index++) {
                (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003000U))) = *(uint32_t *)data;
                data += 4U;
            }
        } else if(1U == data_format) {
            for(index = 0U; index < size; index++) {
                (*(volatile uint16_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003000U))) = *(uint16_t *)data;
                data += 2U;
            }
        } else {
            for(index = 0U; index < size; index++) {
                (*(volatile uint8_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00003000U))) = *(uint8_t *)data;
                data += 1U;
            }
        }
        crc_val = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00003000U)) + 0x00000000U));
