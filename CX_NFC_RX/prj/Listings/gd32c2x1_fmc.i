# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c" 2
# 49 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
void fmc_unlock(void)
{
    if(0U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) & ((uint32_t)((uint32_t)0x01U<<(31))))) {
...
# 65 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
void fmc_lock(void)
{

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) |= ((uint32_t)((uint32_t)0x01U<<(31)));
}
...
FlagStatus fmc_main_flash_empty_stat_get(void)
{
    ...
    if(0U!=((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000000U)) & ((uint32_t)((uint32_t)0x01U<<(16))))) {
        status = SET;
    } else {
        status = RESET;
    }
...
# 99 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
void fmc_main_flash_empty_stat_modify(uint32_t empty_check_status)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000000U)) &= ~((uint32_t)((uint32_t)0x01U<<(16)));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000000U)) |= empty_check_status & ((uint32_t)((uint32_t)0x01U<<(16)));
}
# 114 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
void fmc_wscnt_set(uint32_t wscnt)
{
    uint32_t reg = 0U;
...

    {
        ...
        reg &= ~((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2))));
        reg |= wscnt & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2))));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000000U)) = reg;
    }
}
...
void fmc_prefetch_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(8)));
}
...
# 207 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
fmc_state_enum fmc_page_erase(uint32_t page_number)
{
...

    {
        ...
        fmc_state = fmc_ready_wait(((uint32_t)0xFFFFFFFFU));

        if(FMC_READY == fmc_state) {

            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) &= ~((0xFFFFFFFFUL << (uint8_t)(3)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(8))));
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) |= page_number << (3U);
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) |= ((uint32_t)((uint32_t)0x01U<<(1)));


            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) |= ((uint32_t)((uint32_t)0x01U<<(16)));
...
# 257 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
fmc_state_enum fmc_mass_erase(void)
{
    fmc_state_enum fmc_state;
    ...
    if(FMC_READY == fmc_state) {
        ...
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) |= ((uint32_t)((uint32_t)0x01U<<(2)));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) |= ((uint32_t)((uint32_t)0x01U<<(16)));
...
# 299 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
fmc_state_enum fmc_doubleword_program(uint32_t address, uint64_t data)
{
...

    {
        ...
        if(FMC_READY == fmc_state) {
            ...
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));
...
# 353 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
fmc_state_enum fmc_fast_program(uint32_t address, uint32_t data_buf)
{
    uint8_t index;
    fmc_state_enum fmc_state;
...

    {
        ...
        if(FMC_READY == fmc_state) {
            ...
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) |= ((uint32_t)((uint32_t)0x01U<<(18)));


            for(index = 0U; index < ((uint8_t)8U); index++) {
                (*(volatile uint32_t *)(uint32_t)(address)) = (*(volatile uint32_t *)(uint32_t)(data_buf));
                (*(volatile uint32_t *)(uint32_t)(address + 4U)) = (*(volatile uint32_t *)(uint32_t)(data_buf + 4U));
                address += 8U;
                data_buf += 8U;
            }
...
void fmc_debugger_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(18)));
}
...
void fmc_scr_area_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) |= ((uint32_t)((uint32_t)0x01U<<(28)));
}
# 430 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
void ob_unlock(void)
{
    if(0U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) & ((uint32_t)((uint32_t)0x01U<<(30))))) {

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x0000000CU)) = ((uint32_t)0x08192A3B);
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x0000000CU)) = ((uint32_t)0x4C5D6E7F);
    }
}
# 446 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
void ob_lock(void)
{

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) &= ~((uint32_t)((uint32_t)0x01U<<(30)));
}
...
void ob_reload(void)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) |= ((uint32_t)((uint32_t)0x01U<<(27)));
}
# 516 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
fmc_state_enum ob_user_write(uint32_t ob_user, uint32_t ob_user_mask)
{
    uint32_t obctl_reg;
    fmc_state_enum fmc_state = FMC_UNDEFINEDERR;
# 529 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
    {

        if(((uint8_t)0xCCU) == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000020U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7)))))) {
            ...
            if(FMC_READY == fmc_state) {
                obctl_reg = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000020U));
                (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000020U)) = (obctl_reg & (~ob_user_mask)) | ob_user;
                (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) |= ((uint32_t)((uint32_t)0x01U<<(17)));
...
# 573 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
fmc_state_enum ob_security_protection_level_config(uint8_t ob_spc)
{
    uint32_t obctl_reg;
    fmc_state_enum fmc_state;
    ...
    if(FMC_READY == fmc_state) {
        ...
        obctl_reg &= ~((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7))));
        obctl_reg |= (uint32_t)ob_spc;
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000020U)) = obctl_reg;
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) |= ((uint32_t)((uint32_t)0x01U<<(17)));
...
# 626 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
fmc_state_enum ob_dcrp_area_config(uint32_t dcrp_area, uint32_t dcrp_eren, uint32_t dcrp_start,
                                   uint32_t dcrp_end)
{
    uint32_t reg_value;
...

    {
        ...
        if(((uint8_t)0xCCU) == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000020U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7)))))) {
            ...
            if(FMC_READY == fmc_state) {
                ...
                if(((uint32_t)0x00000000U) == dcrp_area) {
                    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000024U)) = dcrp_start << (0U);
                    reg_value = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000028U));
                    reg_value &= ~((uint32_t)((uint32_t)0x01U<<(31)));
                    reg_value &= ~((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6))));
                    reg_value |= (dcrp_end << (0U));
                    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000028U)) = reg_value;
                } else{
                    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000034U)) = dcrp_start << (0U);
                    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000038U)) = dcrp_end << (0U);
                }


                reg_value = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000028U));
                reg_value &= ~((uint32_t)((uint32_t)0x01U<<(31)));
                reg_value |= dcrp_eren << (31U);
                (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000028U)) = reg_value;
...
# 702 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
fmc_state_enum ob_write_protection_area_config(uint32_t wp_area, uint32_t wp_start, uint32_t wp_end)
{
...

    {
        ...
        } else
        {
            ...
            fmc_state = fmc_ready_wait(((uint32_t)0xFFFFFFFFU));
            if(FMC_READY == fmc_state) {
                value = (wp_start << (0U)) | (wp_end << (16U));

                if(((uint32_t)0x00000000U) == wp_area) {
                    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x0000002CU)) = value;
                } else {
                    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000030U)) = value;
                }
...
# 759 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
fmc_state_enum ob_scr_area_config(uint32_t secure_size)
{
    uint32_t reg_value;
    fmc_state_enum fmc_state;
...

    {
        ...
        if(((uint8_t)0xCCU) == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000020U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7)))))) {
            ...
            if(FMC_READY == fmc_state) {
                ...
                reg_value = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000080U));
                reg_value &= ~((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6))));
                reg_value |= secure_size << (0U);
                (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000080U)) = reg_value;
            }
...
# 820 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
fmc_state_enum ob_boot_lock_config(uint32_t boot_config)
{
    uint32_t reg_value;
    fmc_state_enum fmc_state;
    ...
    if(((uint8_t)0xCCU) == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000020U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7)))))) {
        ...
        if(FMC_READY == fmc_state) {
            reg_value = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000080U));
            reg_value &= ~((uint32_t)((uint32_t)0x01U<<(16)));
            reg_value |= boot_config & ((uint32_t)((uint32_t)0x01U<<(16)));
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000080U)) = reg_value;
...
# 873 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
uint32_t ob_user_get(ob_user_data_extract_info_enum user_data_extract_info, uint8_t * ob_user_data)
{
    uint32_t ret = ((uint32_t)0x00000000U);
...

    {
        ...
        *ob_user_data = (uint8_t)(((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000020U)) & user_data_mask) >> user_data_start_position);
        ret = ((uint32_t)0x00000001U);
    }
    return ret;
}
# 900 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
uint8_t ob_security_protection_level_get(void)
{
    return (uint8_t)(((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000020U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(7))))) >> (0U));
}
# 918 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
uint32_t ob_dcrp_area_get(uint32_t dcrp_area, uint32_t *dcrp_erase_option,
                          uint32_t *dcrp_start, uint32_t *dcrp_end)
{
    uint32_t dcrp_area_start, dcrp_area_end;
    uint32_t ret = ((uint32_t)0x00000000U);
# 932 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
    {
        if(((uint32_t)0x00000000U) == dcrp_area) {
            dcrp_area_start = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000024U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6))))) >> (0U);
            dcrp_area_end = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000028U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6))))) >> (0U);

        } else {
            dcrp_area_start = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000034U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6))))) >> (0U);
            dcrp_area_end = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000038U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6))))) >> (0U);
        }

        *dcrp_erase_option = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000028U)) & ((uint32_t)((uint32_t)0x01U<<(31)))) >> (31U);

        *dcrp_start = ((uint32_t)0x08000000U) + dcrp_area_start * ((uint32_t)0x00000200U);
        *dcrp_end = ((uint32_t)0x08000000U) + (dcrp_area_end + 1U) * ((uint32_t)0x00000200U) - 1U;
        ...
        if(dcrp_area_start <= dcrp_area_end) {
            ...
            ret = ((uint32_t)0x00000000U);
        }
    }
    return ret;
}
# 970 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
uint32_t ob_write_protection_area_get(uint32_t wp_area, uint32_t *wp_start,
                                      uint32_t *wp_end)
{
    uint32_t wp_area_start , wp_area_end ;
    uint32_t ret = ((uint32_t)0x00000000U);
# 983 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
    {
        if(((uint32_t)0x00000000U) == wp_area) {
            wp_area_start = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x0000002CU)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(5))))) >> (0U);
            wp_area_end = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x0000002CU)) & ((0xFFFFFFFFUL << (uint8_t)(16)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(21))))) >> (16U);
        } else {
            wp_area_start = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000030U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(5))))) >> (0U);
            wp_area_end = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000030U)) & ((0xFFFFFFFFUL << (uint8_t)(16)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(21))))) >> (16U);
        }

        *wp_start = ((uint32_t)0x08000000U) + wp_area_start * ((uint32_t)0x00000400U);
        *wp_end = ((uint32_t)0x08000000U) + (wp_area_end + 1U) * ((uint32_t)0x00000400U) - 1U;
...
uint32_t ob_scr_area_get(uint32_t *scr_area_byte_cnt)
{
    ...
    {
        scr_area_byte_size = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000080U)) & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(6))))) >> (0U);
        *scr_area_byte_cnt = scr_area_byte_size * ((uint32_t)0x00000400U);
        ret = ((uint32_t)0x00000001U);
    }
    return ret;
}
# 1035 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
uint32_t ob_boot_lock_get(void)
{
    return (uint32_t)((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000080U)) & ((uint32_t)((uint32_t)0x01U<<(16))));
}
# 1058 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
FlagStatus fmc_flag_get(uint32_t flag)
{
    FlagStatus status = RESET;

    flag &= ((uint32_t)0x0000C2FBU) | ((uint32_t)((uint32_t)0x01U<<(16)));
    if(0U!=((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000010U)) & flag)) {
        status = SET;
    }
...
# 1088 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
void fmc_flag_clear(uint32_t flag)
{

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000010U)) = flag & ((uint32_t)0x0000C2FBU);
}
# 1104 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
void fmc_interrupt_enable(uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) |= interrupt & ((uint32_t)0x07000000U);
}
# 1119 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
void fmc_interrupt_disable(uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000014U)) &= ~(interrupt & ((uint32_t)0x07000000U));
}
# 1134 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
FlagStatus fmc_interrupt_flag_get(uint32_t flag)
{
    FlagStatus status = RESET;

    flag &= ((uint32_t)0x00004003U);
...
# 1157 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
void fmc_interrupt_flag_clear(uint32_t flag)
{

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000010U)) = flag & ((uint32_t)0x00004003U);
}
# 1180 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
fmc_state_enum fmc_state_get(void)
{
    fmc_state_enum fmc_state = FMC_READY;

    if((uint32_t)0x00U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000010U)) & ((uint32_t)((uint32_t)0x01U<<(16))))) {
        fmc_state = FMC_BUSY;
    } else {
        if((uint32_t)0x00U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000010U)) & ((uint32_t)((uint32_t)0x01U<<(4))))) {
            fmc_state = FMC_WPERR;
        } else if((uint32_t)0x00U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000010U)) & ((uint32_t)((uint32_t)0x01U<<(3))))) {
            fmc_state = FMC_PGERR;
        } else if((uint32_t)0x00U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000010U)) & ((uint32_t)((uint32_t)0x01U<<(7))))) {
            fmc_state = FMC_PGSERR;
        } else if((uint32_t)0x00U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000010U)) & ((uint32_t)((uint32_t)0x01U<<(5))))) {
            fmc_state = FMC_PGAERR;
        } else if((uint32_t)0x00U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000010U)) & ((uint32_t)((uint32_t)0x01U<<(14))))) {
            fmc_state = FMC_RPERR;
        } else if((uint32_t)0x00U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000010U)) & ((uint32_t)((uint32_t)0x01U<<(6))))) {
            fmc_state = FMC_PGMERR;
        } else if((uint32_t)0x00U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000010U)) & ((uint32_t)((uint32_t)0x01U<<(9))))) {
            fmc_state = FMC_FSTPERR;
        } else if((uint32_t)0x00U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000010U)) & ((uint32_t)((uint32_t)0x01U<<(1))))) {
            fmc_state = FMC_OPRERR;
        } else if((uint32_t)0x00U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00002000U) + 0x00000010U)) & ((uint32_t)((uint32_t)0x01U<<(15))))) {
            fmc_state = FMC_OBERR;
        } else {
...
# 1233 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_fmc.c"
fmc_state_enum fmc_ready_wait(uint32_t timeout)
{
    fmc_state_enum fmc_state;
