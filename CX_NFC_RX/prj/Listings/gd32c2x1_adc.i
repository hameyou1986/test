# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c" 2
# 35 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
...
# 36 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c" 2
# 71 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_deinit(void)
{
...
void adc_enable(void)
{
    if(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) & ((uint32_t)((uint32_t)0x01U<<(0))))) {

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
    }
}
...
void adc_dma_mode_enable(void)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) |= (uint32_t)(((uint32_t)((uint32_t)0x01U<<(8))));
}
...
# 139 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_discontinuous_mode_config(uint8_t adc_sequence, uint8_t length)
{

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) &= ~((uint32_t)(((uint32_t)((uint32_t)0x01U<<(11))) | ((uint32_t)((uint32_t)0x01U<<(12)))));
    switch(adc_sequence) {
    case ((uint8_t)0x01U):

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) &= ~((uint32_t)((0xFFFFFFFFUL << (uint8_t)(13)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))));
        if((length <= 8U) && (length >= 1U)) {
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) |= (((0xFFFFFFFFUL << (uint8_t)(13)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))) & ((uint32_t)(((uint32_t)length - ((uint8_t)0x01U))) << 13));
        }

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(11)));
        break;
    case ((uint8_t)0x02U):

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(12)));
        break;
    case ((uint8_t)0x04U):
...
# 175 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_special_function_config(uint32_t function, ControlStatus newvalue)
{
    if(ENABLE == newvalue) {

        if(0U != (function & ((uint32_t)((uint32_t)0x01U<<(8))))) {
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(8)));
        }

        if(0U != (function & ((uint32_t)((uint32_t)0x01U<<(10))))) {
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(10)));
        }

        if(0U != (function & ((uint32_t)((uint32_t)0x01U<<(1))))) {
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(1)));
        }
    } else {
...
# 216 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_internal_channel_config(uint32_t internal_channel, ControlStatus newvalue)
{
    if(ENABLE == newvalue) {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) |= (uint32_t)(internal_channel & (((uint32_t)((uint32_t)0x01U<<(23))) | ((uint32_t)((uint32_t)0x01U<<(24)))));
    } else {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) &= ~((uint32_t)internal_channel & (((uint32_t)((uint32_t)0x01U<<(23))) | ((uint32_t)((uint32_t)0x01U<<(24)))));
    }
}
# 234 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_data_alignment_config(uint32_t data_alignment)
{
    if(((uint32_t)0x00000000U) != data_alignment) {

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) |= ((uint32_t)((uint32_t)0x01U<<(11)));
    } else {

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) &= ~((uint32_t)((uint32_t)((uint32_t)0x01U<<(11))));
    }
}
# 257 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_channel_length_config(uint8_t adc_sequence, uint32_t length)
{
    switch(adc_sequence) {
    case ((uint8_t)0x01U):

        if((length >= 1U) && (length <= ((uint32_t)0x00000010U))) {
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x0000002CU)) &= ~((uint32_t)((0xFFFFFFFFUL << (uint8_t)(20)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23)))));
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x0000002CU)) |= (((0xFFFFFFFFUL << (uint8_t)(20)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(23)))) & ((uint32_t)((uint32_t)(length - ((uint8_t)0x01U))) << 20));
        }
        break;
    case ((uint8_t)0x02U):

        if((length >= 1U) && (length <= 4U)) {
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000038U)) &= ~((uint32_t)((0xFFFFFFFFUL << (uint8_t)(20)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(21)))));
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000038U)) |= (((0xFFFFFFFFUL << (uint8_t)(20)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(21)))) & ((uint32_t)((uint32_t)(length - ((uint8_t)0x01U))) << 20));
        }
        break;
    default:
        break;
...
# 298 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_routine_channel_config(uint8_t rank, uint8_t adc_channel, uint32_t sample_time)
{
    uint32_t rsq, sampt;


    if(rank < ((uint8_t)0x06U)) {

        rsq = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000034U));
        rsq &= ~((uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))) << (((uint8_t)0x05U) * rank)));

        rsq |= ((uint32_t)(adc_channel & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3))))) << (((uint8_t)0x05U) * rank));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000034U)) = rsq;
    } else if(rank < ((uint8_t)0x0CU)) {

        rsq = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000030U));
        rsq &= ~((uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))) << (((uint8_t)0x05U) * (rank - ((uint8_t)0x06U)))));

        rsq |= ((uint32_t)(adc_channel & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3))))) << (((uint8_t)0x05U) * (rank - ((uint8_t)0x06U))));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000030U)) = rsq;
    } else {

        rsq = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x0000002CU));
        rsq &= ~((uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))) << (((uint8_t)0x05U) * (rank - ((uint8_t)0x0CU)))));

        rsq |= ((uint32_t)(adc_channel & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3))))) << (((uint8_t)0x05U) * (rank - ((uint8_t)0x0CU))));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x0000002CU)) = rsq;
    }


    if(adc_channel < ((uint8_t)0x0AU)) {

        sampt = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000010U));
        sampt &= ~((uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2)))) << (((uint8_t)0x03U) * adc_channel)));

        sampt |= (uint32_t)((sample_time & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2))))) << (((uint8_t)0x03U) * adc_channel));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000010U)) = sampt;
    } else {

        sampt = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x0000000CU));
        sampt &= ~((uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2)))) << (((uint8_t)0x03U) * (adc_channel - ((uint8_t)0x0AU)))));

        sampt |= (uint32_t)((sample_time & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(2))))) << (((uint8_t)0x03U) * (adc_channel - ((uint8_t)0x0AU))));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x0000000CU)) = sampt;
    }
}
# 363 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_inserted_channel_config(uint8_t rank, uint8_t adc_channel, uint32_t sample_time)
{
    ...
    inserted_length = (uint8_t)((((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000038U))) & ((0xFFFFFFFFUL << (uint8_t)((20U))) & (0xFFFFFFFFUL >> (31U - (uint8_t)((21U)))))) >> (20U));

    if(rank < 4U) {
        isq = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000038U));
        isq &= ~((uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))) << (((uint8_t)0x0FU) - (inserted_length - rank) * ((uint8_t)0x05U))));
        isq |= ((uint32_t)(adc_channel & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3))))) << (((uint8_t)0x0FU) - (inserted_length - rank) * ((uint8_t)0x05U)));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000038U)) = isq;
    }
...
# 408 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_inserted_channel_offset_config(uint8_t inserted_channel, uint16_t offset)
{
    uint8_t inserted_length;
    uint32_t num;
    ...
    inserted_length = (uint8_t)((((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000038U))) & ((0xFFFFFFFFUL << (uint8_t)((20U))) & (0xFFFFFFFFUL >> (31U - (uint8_t)((21U)))))) >> (20U));
    num = ((uint32_t)((uint8_t)0x03U) - ((uint32_t)inserted_length - (uint32_t)inserted_channel));

    if(num <= ((uint8_t)0x03U)) {

        num = num * ((uint8_t)0x04U);

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x14U + num)) = (uint32_t)(offset & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))));
    }
}
# 434 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_external_trigger_config(uint8_t adc_sequence, ControlStatus newvalue)
{
    if(ENABLE == newvalue) {

        if(0U != (adc_sequence & ((uint8_t)0x01U))) {
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(20)));
        }

        if(0U != (adc_sequence & ((uint8_t)0x02U))) {
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(15)));
        }
    } else {
...
# 486 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_external_trigger_source_config(uint8_t adc_sequence, uint32_t external_trigger_source)
{
    switch(adc_sequence) {
    case ((uint8_t)0x01U):

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) &= ~((uint32_t)((0xFFFFFFFFUL << (uint8_t)(17)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(19)))));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) |= (uint32_t)(external_trigger_source & ((0xFFFFFFFFUL << (uint8_t)(17)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(19)))));
        break;
    case ((uint8_t)0x02U):

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) &= ~((uint32_t)((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(14)))));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) |= (uint32_t)(external_trigger_source & ((0xFFFFFFFFUL << (uint8_t)(12)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(14)))));
        break;
    default:
        break;
    }
}
# 513 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_software_trigger_enable(uint8_t adc_sequence)
{

    if(0U != (adc_sequence & ((uint8_t)0x01U))) {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(22)));
    }

    if(0U != (adc_sequence & ((uint8_t)0x02U))) {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000008U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(21)));
    }
}
...
uint16_t adc_routine_data_read(void)
{
    return ((uint16_t)((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x0000004CU))));
}
# 547 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
uint16_t adc_inserted_data_read(uint8_t inserted_channel)
{
    uint32_t idata = 0U;
    ...
    case ((uint8_t)0x00U):
        ...
        idata = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x0000003CU));
        break;
    case ((uint8_t)0x01U):

        idata = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000040U));
        break;
    case ((uint8_t)0x02U):

        idata = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000044U));
        break;
    case ((uint8_t)0x03U):

        idata = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000048U));
        break;
    default:
        break;
    }
...
# 583 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_watchdog0_single_channel_enable(uint8_t adc_channel)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) &= (uint32_t)~(((uint32_t)((uint32_t)0x01U<<(23))) | ((uint32_t)((uint32_t)0x01U<<(22))) | ((uint32_t)((uint32_t)0x01U<<(9))) | ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) |= (uint32_t)(adc_channel & ((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(3)))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) |= (uint32_t)(((uint32_t)((uint32_t)0x01U<<(23))) | ((uint32_t)((uint32_t)0x01U<<(22))) | ((uint32_t)((uint32_t)0x01U<<(9))));
}
# 600 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_watchdog0_sequence_channel_enable(uint8_t adc_sequence)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) &= ~((uint32_t)(((uint32_t)((uint32_t)0x01U<<(23))) | ((uint32_t)((uint32_t)0x01U<<(22))) | ((uint32_t)((uint32_t)0x01U<<(9)))));
    ...
    case ((uint8_t)0x01U):
        ...
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) |= (uint32_t) ((uint32_t)((uint32_t)0x01U<<(23)));
        break;
    case ((uint8_t)0x02U):

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) |= (uint32_t) ((uint32_t)((uint32_t)0x01U<<(22)));
        break;
    case ((uint8_t)0x03U):

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) |= (uint32_t)(((uint32_t)((uint32_t)0x01U<<(23))) | ((uint32_t)((uint32_t)0x01U<<(22))));
        break;
    default:
        break;
    }
...
# 642 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_watchdog1_channel_config(uint32_t selection_channel, ControlStatus newvalue)
{
    if(ENABLE == newvalue) {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000050U)) |= (uint32_t)selection_channel;
    } else {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000050U)) &= ~((uint32_t)selection_channel);
    }
}
# 660 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_watchdog2_channel_config(uint32_t selection_channel, ControlStatus newvalue)
{
    if(ENABLE == newvalue) {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000054U)) |= (uint32_t)selection_channel;
    } else {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000054U)) &= ~((uint32_t)selection_channel);
    }
}
...
void adc_watchdog1_disable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000050U)) &= ~((uint32_t)((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))));
}
...
void adc_watchdog2_disable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000054U)) &= ~((uint32_t)((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(15)))));
}
# 698 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_watchdog0_threshold_config(uint32_t low_threshold, uint32_t high_threshold)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000028U)) = (uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) & ((uint32_t)(low_threshold) << 0U));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000024U)) = (uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) & ((uint32_t)(high_threshold) << 0U));
}
# 711 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_watchdog1_threshold_config(uint32_t low_threshold, uint32_t high_threshold)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x0000005CU)) = (uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) & ((uint32_t)(low_threshold) << 0U));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000058U)) = (uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) & ((uint32_t)(high_threshold) << 0U));
}
# 724 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_watchdog2_threshold_config(uint32_t low_threshold, uint32_t high_threshold)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000064U)) = (uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) & ((uint32_t)(low_threshold) << 0U));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000060U)) = (uint32_t)(((0xFFFFFFFFUL << (uint8_t)(0)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(11)))) & ((uint32_t)(high_threshold) << 0U));
}
# 741 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_resolution_config(uint32_t resolution)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) &= ~((uint32_t)((0xFFFFFFFFUL << (uint8_t)(24)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(25)))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) |= (uint32_t)(resolution & ((0xFFFFFFFFUL << (uint8_t)(24)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(25)))));
}
# 777 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_oversample_mode_config(uint32_t mode, uint16_t shift, uint8_t ratio)
{

    if(((uint32_t)((uint32_t)0x01U<<(9))) == mode) {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000080U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(9)));
    } else {
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000080U)) &= ~((uint32_t)((uint32_t)((uint32_t)0x01U<<(9))));
    }

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000080U)) &= ~((uint32_t)(((0xFFFFFFFFUL << (uint8_t)(2)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(4)))) | ((0xFFFFFFFFUL << (uint8_t)(5)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(8))))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000080U)) |= ((uint32_t)(shift & ((0xFFFFFFFFUL << (uint8_t)(5)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(8))))) | (uint32_t)(ratio & ((0xFFFFFFFFUL << (uint8_t)(2)) & (0xFFFFFFFFUL >> (31U - (uint8_t)(4))))));
}
...
void adc_oversample_mode_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000080U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));
}
...
void adc_oversample_mode_disable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000080U)) &= ~((uint32_t)((uint32_t)((uint32_t)0x01U<<(0))));
}
# 826 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
FlagStatus adc_flag_get(uint32_t flag)
{
    FlagStatus reval = RESET;

    if(0U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000000U)) & flag)) {
        reval = SET;
    }
    return reval;
}
# 850 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_flag_clear(uint32_t flag)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000000U)) &= ~((uint32_t)flag & ((uint32_t)0xC000001FU));
}
# 867 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_interrupt_enable(uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) |= (uint32_t) interrupt & ((uint32_t)0xC00000E0U);
}
# 884 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_interrupt_disable(uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) &= ~((uint32_t)interrupt & ((uint32_t)0xC00000E0U));
}
# 901 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
FlagStatus adc_interrupt_flag_get(uint32_t int_flag)
{
    ...
    case ((uint32_t)((uint32_t)0x01U<<(0))):
        ...
        state = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000000U)) & ((uint32_t)((uint32_t)0x01U<<(0)));
        if((0U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) & ((uint32_t)((uint32_t)0x01U<<(6))))) && (0U != state)) {
            interrupt_flag = SET;
        }
        break;
    case ((uint32_t)((uint32_t)0x01U<<(30))):

        state = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000000U)) & ((uint32_t)((uint32_t)0x01U<<(30)));
        if((0U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) & ((uint32_t)((uint32_t)0x01U<<(30))))) && (0U != state)) {
            interrupt_flag = SET;
        }
        break;
    case ((uint32_t)((uint32_t)0x01U<<(31))):

        state = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000000U)) & ((uint32_t)((uint32_t)0x01U<<(31)));
        if((0U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) & ((uint32_t)((uint32_t)0x01U<<(31))))) && (0U != state)) {
            interrupt_flag = SET;
        }
        break;
    case ((uint32_t)((uint32_t)0x01U<<(1))):

        state = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000000U)) & ((uint32_t)((uint32_t)0x01U<<(1)));
        if((0U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) & ((uint32_t)((uint32_t)0x01U<<(5))))) && (0U != state)) {
            interrupt_flag = SET;
        }
        break;
    case ((uint32_t)((uint32_t)0x01U<<(2))):

        state = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000000U)) & ((uint32_t)((uint32_t)0x01U<<(2)));
        if((0U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000004U)) & ((uint32_t)((uint32_t)0x01U<<(7))))) && (0U != state)) {
            interrupt_flag = SET;
        }
        break;
    default:
...
# 961 "../std/GD32C2x1_Firmware_Library/GD32C2x1_standard_peripheral/Source/gd32c2x1_adc.c"
void adc_interrupt_flag_clear(uint32_t int_flag)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00012400U) + 0x00000000U)) &= ~((uint32_t)int_flag & ((uint32_t)0xC0000007U));
}
